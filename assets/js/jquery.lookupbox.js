          ...
          $.ajax({
            ...
            success: function(result) {
              try {
				...
				//console.log(2);
                settings.item = data;
                //var table = "<table cellspacing='2' cellpadding='3' id='lookupbox-result' class='lookupbox-result'>";
				var table = "<table cellspacing='2' cellpadding='2' id='lookupbox-result' class='table table-striped table-success'>";
