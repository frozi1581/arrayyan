...
//
// Table class for v_tb_pat
//
class cv_tb_pat extends cTable {
	var $KD_PAT;
	var $KET;
	...
	function __construct() {
		...
		$this->TableVar = 'v_tb_pat';
		$this->TableName = 'v_tb_pat';
		...
		// KD_PAT
		$this->KD_PAT = new cField('v_tb_pat', 'v_tb_pat', 'x_KD_PAT', 'KD_PAT', 'tb_pat.KD_PAT', 'tb_pat.KD_PAT', 200, -1, FALSE, 'tb_pat.KD_PAT', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->KD_PAT->Sortable = TRUE; // Allow sort
		$this->fields['KD_PAT'] = &$this->KD_PAT;

		// KET
		$this->KET = new cField('v_tb_pat', 'v_tb_pat', 'x_KET', 'KET', 'tb_pat.KET', 'tb_pat.KET', 200, -1, FALSE, 'tb_pat.KET', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlSelect() { // Select
		return ($this->_SqlSelect <> "") ? $this->_SqlSelect : "SELECT tb_pat.KD_PAT, tb_pat.KET FROM " . $this->getSqlFrom();
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "v_tb_patview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "v_tb_patedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "v_tb_patadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_tb_patview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_tb_patview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_tb_patadd.php?" . $this->UrlParm($parm);
		else
			$url = "v_tb_patadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("v_tb_patedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("v_tb_patadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_tb_patdelete.php", $this->UrlParm());
	}
