...
$tb_latih_add = NULL; // Initialize page object first

class ctb_latih_add extends ctb_latih {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["kd_latih"] != "") {
				...
				$this->setKey("kd_latih", $this->kd_latih->CurrentValue); // Set up key
			} else {
				$this->setKey("kd_latih", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "tb_latihview.php")
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->kd_latih->CurrentValue <> "") { // Check field with unique index
			$sFilter = "(kd_latih = '" . ew_AdjustSql($this->kd_latih->CurrentValue, $this->DBID) . "')";
			$rsChk = $this->LoadRs($sFilter);
			if ($rsChk && !$rsChk->EOF) {
				$sIdxErrMsg = str_replace("%f", $this->kd_latih->FldCaption(), $Language->Phrase("DupIndex"));
				$sIdxErrMsg = str_replace("%v", $this->kd_latih->CurrentValue, $sIdxErrMsg);
		...
		// kd_latih
		$this->kd_latih->SetDbValueDef($rsnew, $this->kd_latih->CurrentValue, "", FALSE);
		...
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['kd_latih']) == "") {
...
// Create page object
if (!isset($tb_latih_add)) $tb_latih_add = new ctb_latih_add();

// Page init
$tb_latih_add->Page_Init();

// Page main
$tb_latih_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_latih_add->Page_Render();
?>
...
var CurrentForm = ftb_latihadd = new ew_Form("ftb_latihadd", "add");

// Validate form
ftb_latihadd.Validate = function() {
...
ftb_latihadd.Form_CustomValidate = 
...
ftb_latihadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $tb_latih_add->ShowPageHeader(); ?>
<?php
$tb_latih_add->ShowMessage();
?>
<form name="ftb_latihadd" id="ftb_latihadd" class="<?php echo $tb_latih_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_latih_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_latih_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_latih">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($tb_latih_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($tb_latih->kd_latih->Visible) { // kd_latih ?>
	<div id="r_kd_latih" class="form-group">
		<label id="elh_tb_latih_kd_latih" for="x_kd_latih" class="<?php echo $tb_latih_add->LeftColumnClass ?>"><?php echo $tb_latih->kd_latih->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tb_latih_add->RightColumnClass ?>"><div<?php echo $tb_latih->kd_latih->CellAttributes() ?>>
<span id="el_tb_latih_kd_latih">
<input type="text" data-table="tb_latih" data-field="x_kd_latih" name="x_kd_latih" id="x_kd_latih" size="30" maxlength="5" placeholder="<?php echo ew_HtmlEncode($tb_latih->kd_latih->getPlaceHolder()) ?>" value="<?php echo $tb_latih->kd_latih->EditValue ?>"<?php echo $tb_latih->kd_latih->EditAttributes() ?>>
</span>
...
<?php if ($tb_latih->ket->Visible) { // ket ?>
	<div id="r_ket" class="form-group">
		<label id="elh_tb_latih_ket" for="x_ket" class="<?php echo $tb_latih_add->LeftColumnClass ?>"><?php echo $tb_latih->ket->FldCaption() ?></label>
		<div class="<?php echo $tb_latih_add->RightColumnClass ?>"><div<?php echo $tb_latih->ket->CellAttributes() ?>>
...
<?php if ($tb_latih->created_by->Visible) { // created_by ?>
	<div id="r_created_by" class="form-group">
		<label id="elh_tb_latih_created_by" for="x_created_by" class="<?php echo $tb_latih_add->LeftColumnClass ?>"><?php echo $tb_latih->created_by->FldCaption() ?></label>
		<div class="<?php echo $tb_latih_add->RightColumnClass ?>"><div<?php echo $tb_latih->created_by->CellAttributes() ?>>
...
<?php if ($tb_latih->created_date->Visible) { // created_date ?>
	<div id="r_created_date" class="form-group">
		<label id="elh_tb_latih_created_date" for="x_created_date" class="<?php echo $tb_latih_add->LeftColumnClass ?>"><?php echo $tb_latih->created_date->FldCaption() ?></label>
		<div class="<?php echo $tb_latih_add->RightColumnClass ?>"><div<?php echo $tb_latih->created_date->CellAttributes() ?>>
...
<?php if ($tb_latih->last_update_by->Visible) { // last_update_by ?>
	<div id="r_last_update_by" class="form-group">
		<label id="elh_tb_latih_last_update_by" for="x_last_update_by" class="<?php echo $tb_latih_add->LeftColumnClass ?>"><?php echo $tb_latih->last_update_by->FldCaption() ?></label>
		<div class="<?php echo $tb_latih_add->RightColumnClass ?>"><div<?php echo $tb_latih->last_update_by->CellAttributes() ?>>
...
<?php if ($tb_latih->last_update_date->Visible) { // last_update_date ?>
	<div id="r_last_update_date" class="form-group">
		<label id="elh_tb_latih_last_update_date" for="x_last_update_date" class="<?php echo $tb_latih_add->LeftColumnClass ?>"><?php echo $tb_latih->last_update_date->FldCaption() ?></label>
		<div class="<?php echo $tb_latih_add->RightColumnClass ?>"><div<?php echo $tb_latih->last_update_date->CellAttributes() ?>>
...
<?php if (!$tb_latih_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tb_latih_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tb_latih_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
