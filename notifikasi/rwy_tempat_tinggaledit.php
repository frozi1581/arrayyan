...
$rwy_tempat_tinggal_edit = NULL; // Initialize page object first

class crwy_tempat_tinggal_edit extends crwy_tempat_tinggal {
	...
	// Page object name
	var $PageObjName = 'rwy_tempat_tinggal_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// kab_kota
			$this->kab_kota->SetDbValueDef($rsnew, $this->kab_kota->CurrentValue, NULL, $this->kab_kota->ReadOnly);
			...
			// tanggal_mulai_ditempati
			$this->tanggal_mulai_ditempati->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tanggal_mulai_ditempati->CurrentValue, 0), NULL, $this->tanggal_mulai_ditempati->ReadOnly);

			// tanggal_berakhir_ditempati
			$this->tanggal_berakhir_ditempati->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tanggal_berakhir_ditempati->CurrentValue, 0), NULL, $this->tanggal_berakhir_ditempati->ReadOnly);
...
// Create page object
if (!isset($rwy_tempat_tinggal_edit)) $rwy_tempat_tinggal_edit = new crwy_tempat_tinggal_edit();

// Page init
$rwy_tempat_tinggal_edit->Page_Init();

// Page main
$rwy_tempat_tinggal_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rwy_tempat_tinggal_edit->Page_Render();
?>
...
var CurrentForm = frwy_tempat_tinggaledit = new ew_Form("frwy_tempat_tinggaledit", "edit");

// Validate form
frwy_tempat_tinggaledit.Validate = function() {
...
frwy_tempat_tinggaledit.Form_CustomValidate = 
...
frwy_tempat_tinggaledit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $rwy_tempat_tinggal_edit->ShowPageHeader(); ?>
<?php
$rwy_tempat_tinggal_edit->ShowMessage();
?>
<form name="frwy_tempat_tinggaledit" id="frwy_tempat_tinggaledit" class="<?php echo $rwy_tempat_tinggal_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rwy_tempat_tinggal_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rwy_tempat_tinggal_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rwy_tempat_tinggal">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($rwy_tempat_tinggal_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($rwy_tempat_tinggal->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_rwy_tempat_tinggal_id" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->id->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->id->CellAttributes() ?>>
<span id="el_rwy_tempat_tinggal_id">
<span<?php echo $rwy_tempat_tinggal->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $rwy_tempat_tinggal->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="rwy_tempat_tinggal" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($rwy_tempat_tinggal->id->CurrentValue) ?>">
<?php echo $rwy_tempat_tinggal->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($rwy_tempat_tinggal->nip->Visible) { // nip ?>
	<div id="r_nip" class="form-group">
		<label id="elh_rwy_tempat_tinggal_nip" for="x_nip" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->nip->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->nip->CellAttributes() ?>>
...
<?php if ($rwy_tempat_tinggal->propinsi->Visible) { // propinsi ?>
	<div id="r_propinsi" class="form-group">
		<label id="elh_rwy_tempat_tinggal_propinsi" for="x_propinsi" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->propinsi->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->propinsi->CellAttributes() ?>>
...
<?php if ($rwy_tempat_tinggal->kab_kota->Visible) { // kab_kota ?>
	<div id="r_kab_kota" class="form-group">
		<label id="elh_rwy_tempat_tinggal_kab_kota" for="x_kab_kota" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->kab_kota->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->kab_kota->CellAttributes() ?>>
...
<?php if ($rwy_tempat_tinggal->kelurahan->Visible) { // kelurahan ?>
	<div id="r_kelurahan" class="form-group">
		<label id="elh_rwy_tempat_tinggal_kelurahan" for="x_kelurahan" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->kelurahan->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->kelurahan->CellAttributes() ?>>
...
<?php if ($rwy_tempat_tinggal->alamat->Visible) { // alamat ?>
	<div id="r_alamat" class="form-group">
		<label id="elh_rwy_tempat_tinggal_alamat" for="x_alamat" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->alamat->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->alamat->CellAttributes() ?>>
...
<?php if ($rwy_tempat_tinggal->tanggal_mulai_ditempati->Visible) { // tanggal_mulai_ditempati ?>
	<div id="r_tanggal_mulai_ditempati" class="form-group">
		<label id="elh_rwy_tempat_tinggal_tanggal_mulai_ditempati" for="x_tanggal_mulai_ditempati" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->tanggal_mulai_ditempati->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->tanggal_mulai_ditempati->CellAttributes() ?>>
...
<?php if ($rwy_tempat_tinggal->tanggal_berakhir_ditempati->Visible) { // tanggal_berakhir_ditempati ?>
	<div id="r_tanggal_berakhir_ditempati" class="form-group">
		<label id="elh_rwy_tempat_tinggal_tanggal_berakhir_ditempati" for="x_tanggal_berakhir_ditempati" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->tanggal_berakhir_ditempati->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->tanggal_berakhir_ditempati->CellAttributes() ?>>
...
<?php if ($rwy_tempat_tinggal->stat_validasi->Visible) { // stat_validasi ?>
	<div id="r_stat_validasi" class="form-group">
		<label id="elh_rwy_tempat_tinggal_stat_validasi" for="x_stat_validasi" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->stat_validasi->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->stat_validasi->CellAttributes() ?>>
...
<?php if ($rwy_tempat_tinggal->change_date->Visible) { // change_date ?>
	<div id="r_change_date" class="form-group">
		<label id="elh_rwy_tempat_tinggal_change_date" for="x_change_date" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->change_date->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->change_date->CellAttributes() ?>>
...
<?php if ($rwy_tempat_tinggal->change_by->Visible) { // change_by ?>
	<div id="r_change_by" class="form-group">
		<label id="elh_rwy_tempat_tinggal_change_by" for="x_change_by" class="<?php echo $rwy_tempat_tinggal_edit->LeftColumnClass ?>"><?php echo $rwy_tempat_tinggal->change_by->FldCaption() ?></label>
		<div class="<?php echo $rwy_tempat_tinggal_edit->RightColumnClass ?>"><div<?php echo $rwy_tempat_tinggal->change_by->CellAttributes() ?>>
...
<?php if (!$rwy_tempat_tinggal_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $rwy_tempat_tinggal_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rwy_tempat_tinggal_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
frwy_tempat_tinggaledit.Init();
</script>
<?php
$rwy_tempat_tinggal_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rwy_tempat_tinggal_edit->Page_Terminate();
?>
