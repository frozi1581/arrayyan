...
$personal_picture_blobview = NULL; // Initialize page object first

class cpersonal_picture_blobview extends cpersonal {
	...
	// Page object name
	var $PageObjName = 'personal_picture_blobview';
...
// Create page object
if (!isset($personal_picture_blobview)) $personal_picture_blobview = new cpersonal_picture_blobview();

// Page init
$personal_picture_blobview->Page_Init();

// Page main
$personal_picture_blobview->Page_Main();
?>
<?php
$personal_picture_blobview->Page_Terminate();
?>
