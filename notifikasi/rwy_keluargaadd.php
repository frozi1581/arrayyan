...
$rwy_keluarga_add = NULL; // Initialize page object first

class crwy_keluarga_add extends crwy_keluarga {
	...
	// Page object name
	var $PageObjName = 'rwy_keluarga_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "rwy_keluargaview.php")
	...
	function LoadDefaultValues() {
		...
		$this->hubungan_keluarga->CurrentValue = NULL;
		$this->hubungan_keluarga->OldValue = $this->hubungan_keluarga->CurrentValue;
	...
	function NewRow() {
		...
		$row['hubungan_keluarga'] = $this->hubungan_keluarga->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// hubungan_keluarga
		$this->hubungan_keluarga->SetDbValueDef($rsnew, $this->hubungan_keluarga->CurrentValue, NULL, FALSE);

		// nama_lengkap
		$this->nama_lengkap->SetDbValueDef($rsnew, $this->nama_lengkap->CurrentValue, NULL, FALSE);

		// tanggal_lahir
		$this->tanggal_lahir->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tanggal_lahir->CurrentValue, 0), NULL, FALSE);
...
// Create page object
if (!isset($rwy_keluarga_add)) $rwy_keluarga_add = new crwy_keluarga_add();

// Page init
$rwy_keluarga_add->Page_Init();

// Page main
$rwy_keluarga_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rwy_keluarga_add->Page_Render();
?>
...
var CurrentForm = frwy_keluargaadd = new ew_Form("frwy_keluargaadd", "add");

// Validate form
frwy_keluargaadd.Validate = function() {
...
frwy_keluargaadd.Form_CustomValidate = 
...
frwy_keluargaadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $rwy_keluarga_add->ShowPageHeader(); ?>
<?php
$rwy_keluarga_add->ShowMessage();
?>
<form name="frwy_keluargaadd" id="frwy_keluargaadd" class="<?php echo $rwy_keluarga_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rwy_keluarga_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rwy_keluarga_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rwy_keluarga">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($rwy_keluarga_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($rwy_keluarga->nip->Visible) { // nip ?>
	<div id="r_nip" class="form-group">
		<label id="elh_rwy_keluarga_nip" for="x_nip" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->nip->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->nip->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->hubungan_keluarga->Visible) { // hubungan_keluarga ?>
	<div id="r_hubungan_keluarga" class="form-group">
		<label id="elh_rwy_keluarga_hubungan_keluarga" for="x_hubungan_keluarga" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->hubungan_keluarga->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->hubungan_keluarga->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->nama_lengkap->Visible) { // nama_lengkap ?>
	<div id="r_nama_lengkap" class="form-group">
		<label id="elh_rwy_keluarga_nama_lengkap" for="x_nama_lengkap" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->nama_lengkap->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->nama_lengkap->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->tanggal_lahir->Visible) { // tanggal_lahir ?>
	<div id="r_tanggal_lahir" class="form-group">
		<label id="elh_rwy_keluarga_tanggal_lahir" for="x_tanggal_lahir" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->tanggal_lahir->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->tanggal_lahir->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->tempat_lahir->Visible) { // tempat_lahir ?>
	<div id="r_tempat_lahir" class="form-group">
		<label id="elh_rwy_keluarga_tempat_lahir" for="x_tempat_lahir" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->tempat_lahir->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->tempat_lahir->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->pendidikan_terakhir->Visible) { // pendidikan_terakhir ?>
	<div id="r_pendidikan_terakhir" class="form-group">
		<label id="elh_rwy_keluarga_pendidikan_terakhir" for="x_pendidikan_terakhir" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->pendidikan_terakhir->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->pendidikan_terakhir->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->jurusan->Visible) { // jurusan ?>
	<div id="r_jurusan" class="form-group">
		<label id="elh_rwy_keluarga_jurusan" for="x_jurusan" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->jurusan->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->jurusan->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->jenis_kelamin->Visible) { // jenis_kelamin ?>
	<div id="r_jenis_kelamin" class="form-group">
		<label id="elh_rwy_keluarga_jenis_kelamin" for="x_jenis_kelamin" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->jenis_kelamin->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->jenis_kelamin->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->stat_validasi->Visible) { // stat_validasi ?>
	<div id="r_stat_validasi" class="form-group">
		<label id="elh_rwy_keluarga_stat_validasi" for="x_stat_validasi" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->stat_validasi->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->stat_validasi->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->change_date->Visible) { // change_date ?>
	<div id="r_change_date" class="form-group">
		<label id="elh_rwy_keluarga_change_date" for="x_change_date" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->change_date->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->change_date->CellAttributes() ?>>
...
<?php if ($rwy_keluarga->change_by->Visible) { // change_by ?>
	<div id="r_change_by" class="form-group">
		<label id="elh_rwy_keluarga_change_by" for="x_change_by" class="<?php echo $rwy_keluarga_add->LeftColumnClass ?>"><?php echo $rwy_keluarga->change_by->FldCaption() ?></label>
		<div class="<?php echo $rwy_keluarga_add->RightColumnClass ?>"><div<?php echo $rwy_keluarga->change_by->CellAttributes() ?>>
...
<?php if (!$rwy_keluarga_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $rwy_keluarga_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rwy_keluarga_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
frwy_keluargaadd.Init();
</script>
<?php
$rwy_keluarga_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rwy_keluarga_add->Page_Terminate();
?>
