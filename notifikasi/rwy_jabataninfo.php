...
//
// Table class for rwy_jabatan
//
class crwy_jabatan extends cTable {
	var $id;
	var $nip;
	...
	var $fungsi_bidang;
	var $berlaku_sejak;
	var $tanggal_berakhir;
	var $no_sk;
	var $tanggal_sk;
	var $status_jabatan;
	var $status_rwy_jabatan;
	var $stat_validasi;
	var $change_by;
	var $change_date;
	...
	function __construct() {
		...
		$this->TableVar = 'rwy_jabatan';
		$this->TableName = 'rwy_jabatan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`rwy_jabatan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('rwy_jabatan', 'rwy_jabatan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// nip
		$this->nip = new cField('rwy_jabatan', 'rwy_jabatan', 'x_nip', 'nip', '`nip`', '`nip`', 200, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip->Sortable = TRUE; // Allow sort
		$this->fields['nip'] = &$this->nip;

		// kode_unit_organisasi
		$this->kode_unit_organisasi = new cField('rwy_jabatan', 'rwy_jabatan', 'x_kode_unit_organisasi', 'kode_unit_organisasi', '`kode_unit_organisasi`', '`kode_unit_organisasi`', 200, -1, FALSE, '`kode_unit_organisasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_unit_organisasi->Sortable = TRUE; // Allow sort
		$this->fields['kode_unit_organisasi'] = &$this->kode_unit_organisasi;

		// kode_unit_kerja
		$this->kode_unit_kerja = new cField('rwy_jabatan', 'rwy_jabatan', 'x_kode_unit_kerja', 'kode_unit_kerja', '`kode_unit_kerja`', '`kode_unit_kerja`', 200, -1, FALSE, '`kode_unit_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_unit_kerja->Sortable = TRUE; // Allow sort
		$this->fields['kode_unit_kerja'] = &$this->kode_unit_kerja;

		// jabatan
		$this->jabatan = new cField('rwy_jabatan', 'rwy_jabatan', 'x_jabatan', 'jabatan', '`jabatan`', '`jabatan`', 200, -1, FALSE, '`jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jabatan->Sortable = TRUE; // Allow sort
		$this->fields['jabatan'] = &$this->jabatan;

		// fungsi_bidang
		$this->fungsi_bidang = new cField('rwy_jabatan', 'rwy_jabatan', 'x_fungsi_bidang', 'fungsi_bidang', '`fungsi_bidang`', '`fungsi_bidang`', 200, -1, FALSE, '`fungsi_bidang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fungsi_bidang->Sortable = TRUE; // Allow sort
		$this->fields['fungsi_bidang'] = &$this->fungsi_bidang;

		// berlaku_sejak
		$this->berlaku_sejak = new cField('rwy_jabatan', 'rwy_jabatan', 'x_berlaku_sejak', 'berlaku_sejak', '`berlaku_sejak`', ew_CastDateFieldForLike('`berlaku_sejak`', 0, "DB"), 133, 0, FALSE, '`berlaku_sejak`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->berlaku_sejak->Sortable = TRUE; // Allow sort
		$this->berlaku_sejak->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['berlaku_sejak'] = &$this->berlaku_sejak;

		// tanggal_berakhir
		$this->tanggal_berakhir = new cField('rwy_jabatan', 'rwy_jabatan', 'x_tanggal_berakhir', 'tanggal_berakhir', '`tanggal_berakhir`', ew_CastDateFieldForLike('`tanggal_berakhir`', 0, "DB"), 133, 0, FALSE, '`tanggal_berakhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tanggal_berakhir->Sortable = TRUE; // Allow sort
		$this->tanggal_berakhir->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['tanggal_berakhir'] = &$this->tanggal_berakhir;

		// no_sk
		$this->no_sk = new cField('rwy_jabatan', 'rwy_jabatan', 'x_no_sk', 'no_sk', '`no_sk`', '`no_sk`', 200, -1, FALSE, '`no_sk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_sk->Sortable = TRUE; // Allow sort
		$this->fields['no_sk'] = &$this->no_sk;

		// tanggal_sk
		$this->tanggal_sk = new cField('rwy_jabatan', 'rwy_jabatan', 'x_tanggal_sk', 'tanggal_sk', '`tanggal_sk`', ew_CastDateFieldForLike('`tanggal_sk`', 0, "DB"), 133, 0, FALSE, '`tanggal_sk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tanggal_sk->Sortable = TRUE; // Allow sort
		$this->tanggal_sk->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['tanggal_sk'] = &$this->tanggal_sk;

		// status_jabatan
		$this->status_jabatan = new cField('rwy_jabatan', 'rwy_jabatan', 'x_status_jabatan', 'status_jabatan', '`status_jabatan`', '`status_jabatan`', 200, -1, FALSE, '`status_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status_jabatan->Sortable = TRUE; // Allow sort
		$this->fields['status_jabatan'] = &$this->status_jabatan;

		// status_rwy_jabatan
		$this->status_rwy_jabatan = new cField('rwy_jabatan', 'rwy_jabatan', 'x_status_rwy_jabatan', 'status_rwy_jabatan', '`status_rwy_jabatan`', '`status_rwy_jabatan`', 200, -1, FALSE, '`status_rwy_jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status_rwy_jabatan->Sortable = TRUE; // Allow sort
		$this->fields['status_rwy_jabatan'] = &$this->status_rwy_jabatan;

		// stat_validasi
		$this->stat_validasi = new cField('rwy_jabatan', 'rwy_jabatan', 'x_stat_validasi', 'stat_validasi', '`stat_validasi`', '`stat_validasi`', 3, -1, FALSE, '`stat_validasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// change_by
		$this->change_by = new cField('rwy_jabatan', 'rwy_jabatan', 'x_change_by', 'change_by', '`change_by`', '`change_by`', 200, -1, FALSE, '`change_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->change_by->Sortable = TRUE; // Allow sort
		$this->fields['change_by'] = &$this->change_by;

		// change_date
		$this->change_date = new cField('rwy_jabatan', 'rwy_jabatan', 'x_change_date', 'change_date', '`change_date`', ew_CastDateFieldForLike('`change_date`', 0, "DB"), 133, 0, FALSE, '`change_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`rwy_jabatan`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "rwy_jabatanedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "rwy_jabatanadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("rwy_jabatanview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("rwy_jabatanview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "rwy_jabatanadd.php?" . $this->UrlParm($parm);
		else
			$url = "rwy_jabatanadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("rwy_jabatanedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("rwy_jabatanadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("rwy_jabatandelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->fungsi_bidang->setDbValue($rs->fields('fungsi_bidang'));
		$this->berlaku_sejak->setDbValue($rs->fields('berlaku_sejak'));
		$this->tanggal_berakhir->setDbValue($rs->fields('tanggal_berakhir'));
		$this->no_sk->setDbValue($rs->fields('no_sk'));
		$this->tanggal_sk->setDbValue($rs->fields('tanggal_sk'));
		$this->status_jabatan->setDbValue($rs->fields('status_jabatan'));
		$this->status_rwy_jabatan->setDbValue($rs->fields('status_rwy_jabatan'));
	...
	function RenderEditRow() {
		...
		$this->fungsi_bidang->EditValue = $this->fungsi_bidang->CurrentValue;
		...
		$this->berlaku_sejak->EditValue = ew_FormatDateTime($this->berlaku_sejak->CurrentValue, 8);
		...
		$this->tanggal_berakhir->EditValue = ew_FormatDateTime($this->tanggal_berakhir->CurrentValue, 8);
		...
		$this->tanggal_sk->EditValue = ew_FormatDateTime($this->tanggal_sk->CurrentValue, 8);
		...
		$this->status_jabatan->EditValue = $this->status_jabatan->CurrentValue;
		...
		$this->status_rwy_jabatan->EditValue = $this->status_rwy_jabatan->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->fungsi_bidang->Exportable) $Doc->ExportCaption($this->fungsi_bidang);
					if ($this->berlaku_sejak->Exportable) $Doc->ExportCaption($this->berlaku_sejak);
					if ($this->tanggal_berakhir->Exportable) $Doc->ExportCaption($this->tanggal_berakhir);
					if ($this->no_sk->Exportable) $Doc->ExportCaption($this->no_sk);
					if ($this->tanggal_sk->Exportable) $Doc->ExportCaption($this->tanggal_sk);
					if ($this->status_jabatan->Exportable) $Doc->ExportCaption($this->status_jabatan);
					if ($this->status_rwy_jabatan->Exportable) $Doc->ExportCaption($this->status_rwy_jabatan);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->fungsi_bidang->Exportable) $Doc->ExportField($this->fungsi_bidang);
						if ($this->berlaku_sejak->Exportable) $Doc->ExportField($this->berlaku_sejak);
						if ($this->tanggal_berakhir->Exportable) $Doc->ExportField($this->tanggal_berakhir);
						if ($this->no_sk->Exportable) $Doc->ExportField($this->no_sk);
						if ($this->tanggal_sk->Exportable) $Doc->ExportField($this->tanggal_sk);
						if ($this->status_jabatan->Exportable) $Doc->ExportField($this->status_jabatan);
						if ($this->status_rwy_jabatan->Exportable) $Doc->ExportField($this->status_rwy_jabatan);
