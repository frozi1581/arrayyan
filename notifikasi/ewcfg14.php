...
define("EW_PROJECT_NAME", "notifikasi", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{8F16C616-6AD2-4381-B7F6-A784BA58350F}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'PouJWig4NrpHnwhj', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/notifikasi.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "10.6.1.110", "port" => 3306, "user" => "root", "pass" => "wikabetonkeren", "db" => "hcis", "qs" => "`", "qe" => "`");
