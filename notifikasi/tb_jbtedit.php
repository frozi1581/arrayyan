...
$tb_jbt_edit = NULL; // Initialize page object first

class ctb_jbt_edit extends ctb_jbt {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// tjb
			$this->tjb->SetDbValueDef($rsnew, $this->tjb->CurrentValue, NULL, $this->tjb->ReadOnly);

			// koef
			$this->koef->SetDbValueDef($rsnew, $this->koef->CurrentValue, NULL, $this->koef->ReadOnly);
			...
			// kd_jbt_old
			$this->kd_jbt_old->SetDbValueDef($rsnew, $this->kd_jbt_old->CurrentValue, NULL, $this->kd_jbt_old->ReadOnly);

			// ket_old
			$this->ket_old->SetDbValueDef($rsnew, $this->ket_old->CurrentValue, NULL, $this->ket_old->ReadOnly);

			// jbt_type
			$this->jbt_type->SetDbValueDef($rsnew, $this->jbt_type->CurrentValue, NULL, $this->jbt_type->ReadOnly);

			// org_id
			$this->org_id->SetDbValueDef($rsnew, $this->org_id->CurrentValue, NULL, $this->org_id->ReadOnly);

			// parent_kd_jbt
			$this->parent_kd_jbt->SetDbValueDef($rsnew, $this->parent_kd_jbt->CurrentValue, NULL, $this->parent_kd_jbt->ReadOnly);

			// eselon_num
			$this->eselon_num->SetDbValueDef($rsnew, $this->eselon_num->CurrentValue, NULL, $this->eselon_num->ReadOnly);

			// jns_jbt
			$this->jns_jbt->SetDbValueDef($rsnew, $this->jns_jbt->CurrentValue, NULL, $this->jns_jbt->ReadOnly);
...
// Create page object
if (!isset($tb_jbt_edit)) $tb_jbt_edit = new ctb_jbt_edit();

// Page init
$tb_jbt_edit->Page_Init();

// Page main
$tb_jbt_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_jbt_edit->Page_Render();
?>
...
var CurrentForm = ftb_jbtedit = new ew_Form("ftb_jbtedit", "edit");

// Validate form
ftb_jbtedit.Validate = function() {
...
ftb_jbtedit.Form_CustomValidate = 
...
ftb_jbtedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $tb_jbt_edit->ShowPageHeader(); ?>
<?php
$tb_jbt_edit->ShowMessage();
?>
<form name="ftb_jbtedit" id="ftb_jbtedit" class="<?php echo $tb_jbt_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_jbt_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_jbt_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_jbt">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tb_jbt_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($tb_jbt->kd_jbt->Visible) { // kd_jbt ?>
	<div id="r_kd_jbt" class="form-group">
		<label id="elh_tb_jbt_kd_jbt" for="x_kd_jbt" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->kd_jbt->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->kd_jbt->CellAttributes() ?>>
<span id="el_tb_jbt_kd_jbt">
<span<?php echo $tb_jbt->kd_jbt->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tb_jbt->kd_jbt->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tb_jbt" data-field="x_kd_jbt" name="x_kd_jbt" id="x_kd_jbt" value="<?php echo ew_HtmlEncode($tb_jbt->kd_jbt->CurrentValue) ?>">
<?php echo $tb_jbt->kd_jbt->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($tb_jbt->ket->Visible) { // ket ?>
	<div id="r_ket" class="form-group">
		<label id="elh_tb_jbt_ket" for="x_ket" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->ket->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->ket->CellAttributes() ?>>
...
<?php if ($tb_jbt->tjb->Visible) { // tjb ?>
	<div id="r_tjb" class="form-group">
		<label id="elh_tb_jbt_tjb" for="x_tjb" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->tjb->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->tjb->CellAttributes() ?>>
...
<?php if ($tb_jbt->koef->Visible) { // koef ?>
	<div id="r_koef" class="form-group">
		<label id="elh_tb_jbt_koef" for="x_koef" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->koef->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->koef->CellAttributes() ?>>
...
<?php if ($tb_jbt->created_by->Visible) { // created_by ?>
	<div id="r_created_by" class="form-group">
		<label id="elh_tb_jbt_created_by" for="x_created_by" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->created_by->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->created_by->CellAttributes() ?>>
...
<?php if ($tb_jbt->created_date->Visible) { // created_date ?>
	<div id="r_created_date" class="form-group">
		<label id="elh_tb_jbt_created_date" for="x_created_date" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->created_date->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->created_date->CellAttributes() ?>>
...
<?php if ($tb_jbt->last_update_by->Visible) { // last_update_by ?>
	<div id="r_last_update_by" class="form-group">
		<label id="elh_tb_jbt_last_update_by" for="x_last_update_by" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->last_update_by->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->last_update_by->CellAttributes() ?>>
...
<?php if ($tb_jbt->last_update_date->Visible) { // last_update_date ?>
	<div id="r_last_update_date" class="form-group">
		<label id="elh_tb_jbt_last_update_date" for="x_last_update_date" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->last_update_date->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->last_update_date->CellAttributes() ?>>
...
<?php if ($tb_jbt->kd_jbt_old->Visible) { // kd_jbt_old ?>
	<div id="r_kd_jbt_old" class="form-group">
		<label id="elh_tb_jbt_kd_jbt_old" for="x_kd_jbt_old" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->kd_jbt_old->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->kd_jbt_old->CellAttributes() ?>>
...
<?php if ($tb_jbt->ket_old->Visible) { // ket_old ?>
	<div id="r_ket_old" class="form-group">
		<label id="elh_tb_jbt_ket_old" for="x_ket_old" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->ket_old->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->ket_old->CellAttributes() ?>>
...
<?php if ($tb_jbt->jbt_type->Visible) { // jbt_type ?>
	<div id="r_jbt_type" class="form-group">
		<label id="elh_tb_jbt_jbt_type" for="x_jbt_type" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->jbt_type->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->jbt_type->CellAttributes() ?>>
...
<?php if ($tb_jbt->org_id->Visible) { // org_id ?>
	<div id="r_org_id" class="form-group">
		<label id="elh_tb_jbt_org_id" for="x_org_id" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->org_id->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->org_id->CellAttributes() ?>>
...
<?php if ($tb_jbt->parent_kd_jbt->Visible) { // parent_kd_jbt ?>
	<div id="r_parent_kd_jbt" class="form-group">
		<label id="elh_tb_jbt_parent_kd_jbt" for="x_parent_kd_jbt" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->parent_kd_jbt->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->parent_kd_jbt->CellAttributes() ?>>
...
<?php if ($tb_jbt->eselon_num->Visible) { // eselon_num ?>
	<div id="r_eselon_num" class="form-group">
		<label id="elh_tb_jbt_eselon_num" for="x_eselon_num" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->eselon_num->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->eselon_num->CellAttributes() ?>>
...
<?php if ($tb_jbt->jns_jbt->Visible) { // jns_jbt ?>
	<div id="r_jns_jbt" class="form-group">
		<label id="elh_tb_jbt_jns_jbt" for="x_jns_jbt" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->jns_jbt->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->jns_jbt->CellAttributes() ?>>
...
<?php if ($tb_jbt->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_tb_jbt_status" for="x_status" class="<?php echo $tb_jbt_edit->LeftColumnClass ?>"><?php echo $tb_jbt->status->FldCaption() ?></label>
		<div class="<?php echo $tb_jbt_edit->RightColumnClass ?>"><div<?php echo $tb_jbt->status->CellAttributes() ?>>
...
<?php if (!$tb_jbt_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tb_jbt_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tb_jbt_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
