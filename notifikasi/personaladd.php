...
class cpersonal_add extends cpersonal {
	...
	function LoadDefaultValues() {
		...
		$this->first_title->CurrentValue = NULL;
		$this->first_title->OldValue = $this->first_title->CurrentValue;
		$this->last_title->CurrentValue = NULL;
		$this->last_title->OldValue = $this->last_title->CurrentValue;
		$this->init->CurrentValue = NULL;
		$this->init->OldValue = $this->init->CurrentValue;
		$this->tpt_lahir->CurrentValue = NULL;
		$this->tpt_lahir->OldValue = $this->tpt_lahir->CurrentValue;
		...
		$this->kd_agama->CurrentValue = NULL;
		$this->kd_agama->OldValue = $this->kd_agama->CurrentValue;
		$this->tgl_masuk->CurrentValue = NULL;
		$this->tgl_masuk->OldValue = $this->tgl_masuk->CurrentValue;
		$this->tpt_masuk->CurrentValue = NULL;
		$this->tpt_masuk->OldValue = $this->tpt_masuk->CurrentValue;
		$this->stkel->CurrentValue = NULL;
		$this->stkel->OldValue = $this->stkel->CurrentValue;
		$this->alamat->CurrentValue = NULL;
		$this->alamat->OldValue = $this->alamat->CurrentValue;
		$this->kota->CurrentValue = NULL;
		$this->kota->OldValue = $this->kota->CurrentValue;
		$this->kd_pos->CurrentValue = NULL;
		$this->kd_pos->OldValue = $this->kd_pos->CurrentValue;
		$this->kd_propinsi->CurrentValue = NULL;
		$this->kd_propinsi->OldValue = $this->kd_propinsi->CurrentValue;
		$this->telp->CurrentValue = NULL;
		$this->telp->OldValue = $this->telp->CurrentValue;
		$this->telp_area->CurrentValue = NULL;
		$this->telp_area->OldValue = $this->telp_area->CurrentValue;
		$this->hp->CurrentValue = NULL;
		$this->hp->OldValue = $this->hp->CurrentValue;
		$this->alamat_dom->CurrentValue = NULL;
		$this->alamat_dom->OldValue = $this->alamat_dom->CurrentValue;
		$this->kota_dom->CurrentValue = NULL;
		$this->kota_dom->OldValue = $this->kota_dom->CurrentValue;
		$this->kd_pos_dom->CurrentValue = NULL;
		$this->kd_pos_dom->OldValue = $this->kd_pos_dom->CurrentValue;
		$this->kd_propinsi_dom->CurrentValue = NULL;
		$this->kd_propinsi_dom->OldValue = $this->kd_propinsi_dom->CurrentValue;
		$this->telp_dom->CurrentValue = NULL;
		$this->telp_dom->OldValue = $this->telp_dom->CurrentValue;
		$this->telp_dom_area->CurrentValue = NULL;
		$this->telp_dom_area->OldValue = $this->telp_dom_area->CurrentValue;
		$this->_email->CurrentValue = NULL;
		$this->_email->OldValue = $this->_email->CurrentValue;
		$this->kd_st_emp->CurrentValue = NULL;
		$this->kd_st_emp->OldValue = $this->kd_st_emp->CurrentValue;
		$this->skala->CurrentValue = NULL;
		$this->skala->OldValue = $this->skala->CurrentValue;
		$this->gp->CurrentValue = 0;
		$this->upah_tetap->CurrentValue = 0.00;
		$this->tgl_honor->CurrentValue = NULL;
		$this->tgl_honor->OldValue = $this->tgl_honor->CurrentValue;
		$this->honor->CurrentValue = 0;
		$this->premi_honor->CurrentValue = 0.00;
		$this->tgl_gp->CurrentValue = NULL;
		$this->tgl_gp->OldValue = $this->tgl_gp->CurrentValue;
		$this->skala_95->CurrentValue = NULL;
		$this->skala_95->OldValue = $this->skala_95->CurrentValue;
		$this->gp_95->CurrentValue = 0;
		$this->tgl_gp_95->CurrentValue = NULL;
		$this->tgl_gp_95->OldValue = $this->tgl_gp_95->CurrentValue;
		$this->kd_indx->CurrentValue = NULL;
		$this->kd_indx->OldValue = $this->kd_indx->CurrentValue;
		$this->indx_lok->CurrentValue = NULL;
		$this->indx_lok->OldValue = $this->indx_lok->CurrentValue;
		...
		$this->tgl_kd_jbt->CurrentValue = NULL;
		$this->tgl_kd_jbt->OldValue = $this->tgl_kd_jbt->CurrentValue;
		$this->kd_jbt_pgs->CurrentValue = NULL;
		$this->kd_jbt_pgs->OldValue = $this->kd_jbt_pgs->CurrentValue;
		$this->tgl_kd_jbt_pgs->CurrentValue = NULL;
		$this->tgl_kd_jbt_pgs->OldValue = $this->tgl_kd_jbt_pgs->CurrentValue;
		$this->kd_jbt_pjs->CurrentValue = NULL;
		$this->kd_jbt_pjs->OldValue = $this->kd_jbt_pjs->CurrentValue;
		$this->tgl_kd_jbt_pjs->CurrentValue = NULL;
		$this->tgl_kd_jbt_pjs->OldValue = $this->tgl_kd_jbt_pjs->CurrentValue;
		$this->kd_jbt_ps->CurrentValue = NULL;
		$this->kd_jbt_ps->OldValue = $this->kd_jbt_ps->CurrentValue;
		$this->tgl_kd_jbt_ps->CurrentValue = NULL;
		$this->tgl_kd_jbt_ps->OldValue = $this->tgl_kd_jbt_ps->CurrentValue;
		$this->kd_pat->CurrentValue = NULL;
		$this->kd_pat->OldValue = $this->kd_pat->CurrentValue;
		$this->kd_gas->CurrentValue = NULL;
		$this->kd_gas->OldValue = $this->kd_gas->CurrentValue;
		$this->pimp_empid->CurrentValue = NULL;
		$this->pimp_empid->OldValue = $this->pimp_empid->CurrentValue;
		$this->stshift->CurrentValue = "H";
		$this->no_rek->CurrentValue = NULL;
		$this->no_rek->OldValue = $this->no_rek->CurrentValue;
		$this->kd_bank->CurrentValue = NULL;
		$this->kd_bank->OldValue = $this->kd_bank->CurrentValue;
		$this->kd_jamsostek->CurrentValue = NULL;
		$this->kd_jamsostek->OldValue = $this->kd_jamsostek->CurrentValue;
		$this->acc_astek->CurrentValue = NULL;
		$this->acc_astek->OldValue = $this->acc_astek->CurrentValue;
		$this->acc_dapens->CurrentValue = NULL;
		$this->acc_dapens->OldValue = $this->acc_dapens->CurrentValue;
		$this->acc_kes->CurrentValue = NULL;
		$this->acc_kes->OldValue = $this->acc_kes->CurrentValue;
		$this->st->CurrentValue = NULL;
		$this->st->OldValue = $this->st->CurrentValue;
		$this->signature->Upload->DbValue = NULL;
		$this->signature->OldValue = $this->signature->Upload->DbValue;
		...
		$this->fgr_print_id->CurrentValue = NULL;
		$this->fgr_print_id->OldValue = $this->fgr_print_id->CurrentValue;
		...
		$this->paraf->Upload->DbValue = NULL;
		$this->paraf->OldValue = $this->paraf->Upload->DbValue;
		$this->tgl_keluar->CurrentValue = NULL;
		$this->tgl_keluar->OldValue = $this->tgl_keluar->CurrentValue;
		$this->nama_nasabah->CurrentValue = NULL;
		$this->nama_nasabah->OldValue = $this->nama_nasabah->CurrentValue;
		$this->no_ktp->CurrentValue = NULL;
		$this->no_ktp->OldValue = $this->no_ktp->CurrentValue;
		$this->no_kokar->CurrentValue = NULL;
		$this->no_kokar->OldValue = $this->no_kokar->CurrentValue;
		$this->no_bmw->CurrentValue = NULL;
		$this->no_bmw->OldValue = $this->no_bmw->CurrentValue;
		$this->no_bpjs_ketenagakerjaan->CurrentValue = NULL;
		$this->no_bpjs_ketenagakerjaan->OldValue = $this->no_bpjs_ketenagakerjaan->CurrentValue;
		$this->no_bpjs_kesehatan->CurrentValue = NULL;
		$this->no_bpjs_kesehatan->OldValue = $this->no_bpjs_kesehatan->CurrentValue;
		$this->eselon->CurrentValue = NULL;
		$this->eselon->OldValue = $this->eselon->CurrentValue;
		$this->kd_jenjang->CurrentValue = NULL;
		$this->kd_jenjang->OldValue = $this->kd_jenjang->CurrentValue;
		$this->kd_jbt_esl->CurrentValue = NULL;
		$this->kd_jbt_esl->OldValue = $this->kd_jbt_esl->CurrentValue;
		$this->tgl_jbt_esl->CurrentValue = NULL;
		$this->tgl_jbt_esl->OldValue = $this->tgl_jbt_esl->CurrentValue;
		...
		$this->kd_payroll->CurrentValue = NULL;
		$this->kd_payroll->OldValue = $this->kd_payroll->CurrentValue;
		$this->id_wn->CurrentValue = NULL;
		$this->id_wn->OldValue = $this->id_wn->CurrentValue;
		$this->no_anggota_kkms->CurrentValue = NULL;
		$this->no_anggota_kkms->OldValue = $this->no_anggota_kkms->CurrentValue;
	}
	...
	function NewRow() {
		...
		$row['first_title'] = $this->first_title->CurrentValue;
		$row['last_title'] = $this->last_title->CurrentValue;
		$row['init'] = $this->init->CurrentValue;
		$row['tpt_lahir'] = $this->tpt_lahir->CurrentValue;
		$row['tgl_lahir'] = $this->tgl_lahir->CurrentValue;
		$row['jk'] = $this->jk->CurrentValue;
		$row['kd_agama'] = $this->kd_agama->CurrentValue;
		$row['tgl_masuk'] = $this->tgl_masuk->CurrentValue;
		$row['tpt_masuk'] = $this->tpt_masuk->CurrentValue;
		$row['stkel'] = $this->stkel->CurrentValue;
		$row['alamat'] = $this->alamat->CurrentValue;
		$row['kota'] = $this->kota->CurrentValue;
		$row['kd_pos'] = $this->kd_pos->CurrentValue;
		$row['kd_propinsi'] = $this->kd_propinsi->CurrentValue;
		$row['telp'] = $this->telp->CurrentValue;
		$row['telp_area'] = $this->telp_area->CurrentValue;
		$row['hp'] = $this->hp->CurrentValue;
		$row['alamat_dom'] = $this->alamat_dom->CurrentValue;
		$row['kota_dom'] = $this->kota_dom->CurrentValue;
		$row['kd_pos_dom'] = $this->kd_pos_dom->CurrentValue;
		$row['kd_propinsi_dom'] = $this->kd_propinsi_dom->CurrentValue;
		$row['telp_dom'] = $this->telp_dom->CurrentValue;
		$row['telp_dom_area'] = $this->telp_dom_area->CurrentValue;
		$row['email'] = $this->_email->CurrentValue;
		$row['kd_st_emp'] = $this->kd_st_emp->CurrentValue;
		$row['skala'] = $this->skala->CurrentValue;
		$row['gp'] = $this->gp->CurrentValue;
		$row['upah_tetap'] = $this->upah_tetap->CurrentValue;
		$row['tgl_honor'] = $this->tgl_honor->CurrentValue;
		$row['honor'] = $this->honor->CurrentValue;
		$row['premi_honor'] = $this->premi_honor->CurrentValue;
		$row['tgl_gp'] = $this->tgl_gp->CurrentValue;
		$row['skala_95'] = $this->skala_95->CurrentValue;
		$row['gp_95'] = $this->gp_95->CurrentValue;
		$row['tgl_gp_95'] = $this->tgl_gp_95->CurrentValue;
		$row['kd_indx'] = $this->kd_indx->CurrentValue;
		$row['indx_lok'] = $this->indx_lok->CurrentValue;
		$row['gol_darah'] = $this->gol_darah->CurrentValue;
		$row['kd_jbt'] = $this->kd_jbt->CurrentValue;
		$row['tgl_kd_jbt'] = $this->tgl_kd_jbt->CurrentValue;
		$row['kd_jbt_pgs'] = $this->kd_jbt_pgs->CurrentValue;
		$row['tgl_kd_jbt_pgs'] = $this->tgl_kd_jbt_pgs->CurrentValue;
		$row['kd_jbt_pjs'] = $this->kd_jbt_pjs->CurrentValue;
		$row['tgl_kd_jbt_pjs'] = $this->tgl_kd_jbt_pjs->CurrentValue;
		$row['kd_jbt_ps'] = $this->kd_jbt_ps->CurrentValue;
		$row['tgl_kd_jbt_ps'] = $this->tgl_kd_jbt_ps->CurrentValue;
		$row['kd_pat'] = $this->kd_pat->CurrentValue;
		$row['kd_gas'] = $this->kd_gas->CurrentValue;
		$row['pimp_empid'] = $this->pimp_empid->CurrentValue;
		$row['stshift'] = $this->stshift->CurrentValue;
		$row['no_rek'] = $this->no_rek->CurrentValue;
		$row['kd_bank'] = $this->kd_bank->CurrentValue;
		$row['kd_jamsostek'] = $this->kd_jamsostek->CurrentValue;
		$row['acc_astek'] = $this->acc_astek->CurrentValue;
		$row['acc_dapens'] = $this->acc_dapens->CurrentValue;
		$row['acc_kes'] = $this->acc_kes->CurrentValue;
		$row['st'] = $this->st->CurrentValue;
		$row['signature'] = $this->signature->Upload->DbValue;
		...
		$row['fgr_print_id'] = $this->fgr_print_id->CurrentValue;
		$row['kd_jbt_eselon'] = $this->kd_jbt_eselon->CurrentValue;
		$row['npwp'] = $this->npwp->CurrentValue;
		$row['paraf'] = $this->paraf->Upload->DbValue;
		$row['tgl_keluar'] = $this->tgl_keluar->CurrentValue;
		$row['nama_nasabah'] = $this->nama_nasabah->CurrentValue;
		$row['no_ktp'] = $this->no_ktp->CurrentValue;
		$row['no_kokar'] = $this->no_kokar->CurrentValue;
		$row['no_bmw'] = $this->no_bmw->CurrentValue;
		$row['no_bpjs_ketenagakerjaan'] = $this->no_bpjs_ketenagakerjaan->CurrentValue;
		$row['no_bpjs_kesehatan'] = $this->no_bpjs_kesehatan->CurrentValue;
		$row['eselon'] = $this->eselon->CurrentValue;
		$row['kd_jenjang'] = $this->kd_jenjang->CurrentValue;
		$row['kd_jbt_esl'] = $this->kd_jbt_esl->CurrentValue;
		$row['tgl_jbt_esl'] = $this->tgl_jbt_esl->CurrentValue;
		$row['org_id'] = $this->org_id->CurrentValue;
		$row['picture'] = $this->picture->Upload->DbValue;
		$row['kd_payroll'] = $this->kd_payroll->CurrentValue;
		$row['id_wn'] = $this->id_wn->CurrentValue;
		$row['no_anggota_kkms'] = $this->no_anggota_kkms->CurrentValue;
		return $row;
	}
	...
	function RenderRow() {
		...
		$this->no_anggota_kkms->ViewCustomAttributes = "";
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->signature);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->paraf);
	...
	function AddRow($rsold = NULL) {
		...
		// first_title
		$this->first_title->SetDbValueDef($rsnew, $this->first_title->CurrentValue, NULL, FALSE);

		// last_title
		$this->last_title->SetDbValueDef($rsnew, $this->last_title->CurrentValue, NULL, FALSE);

		// init
		$this->init->SetDbValueDef($rsnew, $this->init->CurrentValue, NULL, FALSE);

		// tpt_lahir
		$this->tpt_lahir->SetDbValueDef($rsnew, $this->tpt_lahir->CurrentValue, NULL, FALSE);
		...
		// kd_agama
		$this->kd_agama->SetDbValueDef($rsnew, $this->kd_agama->CurrentValue, NULL, FALSE);

		// tgl_masuk
		$this->tgl_masuk->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_masuk->CurrentValue, 0), NULL, FALSE);

		// tpt_masuk
		$this->tpt_masuk->SetDbValueDef($rsnew, $this->tpt_masuk->CurrentValue, NULL, FALSE);

		// stkel
		$this->stkel->SetDbValueDef($rsnew, $this->stkel->CurrentValue, NULL, FALSE);
		...
		// kd_pos
		$this->kd_pos->SetDbValueDef($rsnew, $this->kd_pos->CurrentValue, NULL, FALSE);

		// kd_propinsi
		$this->kd_propinsi->SetDbValueDef($rsnew, $this->kd_propinsi->CurrentValue, NULL, FALSE);

		// telp
		$this->telp->SetDbValueDef($rsnew, $this->telp->CurrentValue, NULL, FALSE);

		// telp_area
		$this->telp_area->SetDbValueDef($rsnew, $this->telp_area->CurrentValue, NULL, FALSE);

		// hp
		$this->hp->SetDbValueDef($rsnew, $this->hp->CurrentValue, NULL, FALSE);

		// alamat_dom
		$this->alamat_dom->SetDbValueDef($rsnew, $this->alamat_dom->CurrentValue, NULL, FALSE);

		// kota_dom
		$this->kota_dom->SetDbValueDef($rsnew, $this->kota_dom->CurrentValue, NULL, FALSE);

		// kd_pos_dom
		$this->kd_pos_dom->SetDbValueDef($rsnew, $this->kd_pos_dom->CurrentValue, NULL, FALSE);

		// kd_propinsi_dom
		$this->kd_propinsi_dom->SetDbValueDef($rsnew, $this->kd_propinsi_dom->CurrentValue, NULL, FALSE);

		// telp_dom
		$this->telp_dom->SetDbValueDef($rsnew, $this->telp_dom->CurrentValue, NULL, FALSE);

		// telp_dom_area
		$this->telp_dom_area->SetDbValueDef($rsnew, $this->telp_dom_area->CurrentValue, NULL, FALSE);

		// email
		$this->_email->SetDbValueDef($rsnew, $this->_email->CurrentValue, NULL, FALSE);

		// kd_st_emp
		$this->kd_st_emp->SetDbValueDef($rsnew, $this->kd_st_emp->CurrentValue, NULL, FALSE);

		// skala
		$this->skala->SetDbValueDef($rsnew, $this->skala->CurrentValue, NULL, FALSE);

		// gp
		$this->gp->SetDbValueDef($rsnew, $this->gp->CurrentValue, NULL, strval($this->gp->CurrentValue) == "");

		// upah_tetap
		$this->upah_tetap->SetDbValueDef($rsnew, $this->upah_tetap->CurrentValue, NULL, strval($this->upah_tetap->CurrentValue) == "");

		// tgl_honor
		$this->tgl_honor->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_honor->CurrentValue, 0), NULL, FALSE);

		// honor
		$this->honor->SetDbValueDef($rsnew, $this->honor->CurrentValue, NULL, strval($this->honor->CurrentValue) == "");

		// premi_honor
		$this->premi_honor->SetDbValueDef($rsnew, $this->premi_honor->CurrentValue, NULL, strval($this->premi_honor->CurrentValue) == "");

		// tgl_gp
		$this->tgl_gp->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_gp->CurrentValue, 0), NULL, FALSE);

		// skala_95
		$this->skala_95->SetDbValueDef($rsnew, $this->skala_95->CurrentValue, NULL, FALSE);

		// gp_95
		$this->gp_95->SetDbValueDef($rsnew, $this->gp_95->CurrentValue, NULL, strval($this->gp_95->CurrentValue) == "");

		// tgl_gp_95
		$this->tgl_gp_95->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_gp_95->CurrentValue, 0), NULL, FALSE);

		// kd_indx
		$this->kd_indx->SetDbValueDef($rsnew, $this->kd_indx->CurrentValue, NULL, FALSE);

		// indx_lok
		$this->indx_lok->SetDbValueDef($rsnew, $this->indx_lok->CurrentValue, NULL, FALSE);
		...
		// tgl_kd_jbt
		$this->tgl_kd_jbt->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_kd_jbt->CurrentValue, 0), NULL, FALSE);

		// kd_jbt_pgs
		$this->kd_jbt_pgs->SetDbValueDef($rsnew, $this->kd_jbt_pgs->CurrentValue, NULL, FALSE);

		// tgl_kd_jbt_pgs
		$this->tgl_kd_jbt_pgs->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_kd_jbt_pgs->CurrentValue, 0), NULL, FALSE);

		// kd_jbt_pjs
		$this->kd_jbt_pjs->SetDbValueDef($rsnew, $this->kd_jbt_pjs->CurrentValue, NULL, FALSE);

		// tgl_kd_jbt_pjs
		$this->tgl_kd_jbt_pjs->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_kd_jbt_pjs->CurrentValue, 0), NULL, FALSE);

		// kd_jbt_ps
		$this->kd_jbt_ps->SetDbValueDef($rsnew, $this->kd_jbt_ps->CurrentValue, NULL, FALSE);

		// tgl_kd_jbt_ps
		$this->tgl_kd_jbt_ps->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_kd_jbt_ps->CurrentValue, 0), NULL, FALSE);

		// kd_pat
		$this->kd_pat->SetDbValueDef($rsnew, $this->kd_pat->CurrentValue, NULL, FALSE);

		// kd_gas
		$this->kd_gas->SetDbValueDef($rsnew, $this->kd_gas->CurrentValue, NULL, FALSE);

		// pimp_empid
		$this->pimp_empid->SetDbValueDef($rsnew, $this->pimp_empid->CurrentValue, NULL, FALSE);

		// stshift
		$this->stshift->SetDbValueDef($rsnew, $this->stshift->CurrentValue, NULL, strval($this->stshift->CurrentValue) == "");

		// no_rek
		$this->no_rek->SetDbValueDef($rsnew, $this->no_rek->CurrentValue, NULL, FALSE);

		// kd_bank
		$this->kd_bank->SetDbValueDef($rsnew, $this->kd_bank->CurrentValue, NULL, FALSE);

		// kd_jamsostek
		$this->kd_jamsostek->SetDbValueDef($rsnew, $this->kd_jamsostek->CurrentValue, NULL, FALSE);

		// acc_astek
		$this->acc_astek->SetDbValueDef($rsnew, $this->acc_astek->CurrentValue, NULL, FALSE);

		// acc_dapens
		$this->acc_dapens->SetDbValueDef($rsnew, $this->acc_dapens->CurrentValue, NULL, FALSE);

		// acc_kes
		$this->acc_kes->SetDbValueDef($rsnew, $this->acc_kes->CurrentValue, NULL, FALSE);

		// st
		$this->st->SetDbValueDef($rsnew, $this->st->CurrentValue, NULL, FALSE);

		// signature
		if ($this->signature->Visible && !$this->signature->Upload->KeepFile) {
		...
		// fgr_print_id
		$this->fgr_print_id->SetDbValueDef($rsnew, $this->fgr_print_id->CurrentValue, NULL, FALSE);
		...
		// paraf
		if ($this->paraf->Visible && !$this->paraf->Upload->KeepFile) {
		...
		// tgl_keluar
		$this->tgl_keluar->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_keluar->CurrentValue, 0), NULL, FALSE);

		// nama_nasabah
		$this->nama_nasabah->SetDbValueDef($rsnew, $this->nama_nasabah->CurrentValue, NULL, FALSE);

		// no_ktp
		$this->no_ktp->SetDbValueDef($rsnew, $this->no_ktp->CurrentValue, NULL, FALSE);

		// no_kokar
		$this->no_kokar->SetDbValueDef($rsnew, $this->no_kokar->CurrentValue, NULL, FALSE);

		// no_bmw
		$this->no_bmw->SetDbValueDef($rsnew, $this->no_bmw->CurrentValue, NULL, FALSE);

		// no_bpjs_ketenagakerjaan
		$this->no_bpjs_ketenagakerjaan->SetDbValueDef($rsnew, $this->no_bpjs_ketenagakerjaan->CurrentValue, NULL, FALSE);

		// no_bpjs_kesehatan
		$this->no_bpjs_kesehatan->SetDbValueDef($rsnew, $this->no_bpjs_kesehatan->CurrentValue, NULL, FALSE);

		// eselon
		$this->eselon->SetDbValueDef($rsnew, $this->eselon->CurrentValue, NULL, FALSE);

		// kd_jenjang
		$this->kd_jenjang->SetDbValueDef($rsnew, $this->kd_jenjang->CurrentValue, NULL, FALSE);

		// kd_jbt_esl
		$this->kd_jbt_esl->SetDbValueDef($rsnew, $this->kd_jbt_esl->CurrentValue, NULL, FALSE);

		// tgl_jbt_esl
		$this->tgl_jbt_esl->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_jbt_esl->CurrentValue, 0), NULL, FALSE);
		...
		// kd_payroll
		$this->kd_payroll->SetDbValueDef($rsnew, $this->kd_payroll->CurrentValue, NULL, FALSE);

		// id_wn
		$this->id_wn->SetDbValueDef($rsnew, $this->id_wn->CurrentValue, NULL, FALSE);

		// no_anggota_kkms
		$this->no_anggota_kkms->SetDbValueDef($rsnew, $this->no_anggota_kkms->CurrentValue, NULL, FALSE);
...
fpersonaladd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($personal_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($personal->employee_id->Visible) { // employee_id ?>
	<div id="r_employee_id" class="form-group">
		<label id="elh_personal_employee_id" for="x_employee_id" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->employee_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->employee_id->CellAttributes() ?>>
<span id="el_personal_employee_id">
<input type="text" data-table="personal" data-field="x_employee_id" name="x_employee_id" id="x_employee_id" size="30" maxlength="8" placeholder="<?php echo ew_HtmlEncode($personal->employee_id->getPlaceHolder()) ?>" value="<?php echo $personal->employee_id->EditValue ?>"<?php echo $personal->employee_id->EditAttributes() ?>>
</span>
...
<?php if ($personal->first_name->Visible) { // first_name ?>
	<div id="r_first_name" class="form-group">
		<label id="elh_personal_first_name" for="x_first_name" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->first_name->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->first_name->CellAttributes() ?>>
...
<?php if ($personal->last_name->Visible) { // last_name ?>
	<div id="r_last_name" class="form-group">
		<label id="elh_personal_last_name" for="x_last_name" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->last_name->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->last_name->CellAttributes() ?>>
...
<?php if ($personal->first_title->Visible) { // first_title ?>
	<div id="r_first_title" class="form-group">
		<label id="elh_personal_first_title" for="x_first_title" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->first_title->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->first_title->CellAttributes() ?>>
...
<?php if ($personal->last_title->Visible) { // last_title ?>
	<div id="r_last_title" class="form-group">
		<label id="elh_personal_last_title" for="x_last_title" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->last_title->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->last_title->CellAttributes() ?>>
...
<?php if ($personal->init->Visible) { // init ?>
	<div id="r_init" class="form-group">
		<label id="elh_personal_init" for="x_init" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->init->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->init->CellAttributes() ?>>
...
<?php if ($personal->tpt_lahir->Visible) { // tpt_lahir ?>
	<div id="r_tpt_lahir" class="form-group">
		<label id="elh_personal_tpt_lahir" for="x_tpt_lahir" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tpt_lahir->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tpt_lahir->CellAttributes() ?>>
...
<?php if ($personal->tgl_lahir->Visible) { // tgl_lahir ?>
	<div id="r_tgl_lahir" class="form-group">
		<label id="elh_personal_tgl_lahir" for="x_tgl_lahir" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_lahir->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_lahir->CellAttributes() ?>>
...
<?php if ($personal->jk->Visible) { // jk ?>
	<div id="r_jk" class="form-group">
		<label id="elh_personal_jk" for="x_jk" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->jk->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->jk->CellAttributes() ?>>
...
<?php if ($personal->kd_agama->Visible) { // kd_agama ?>
	<div id="r_kd_agama" class="form-group">
		<label id="elh_personal_kd_agama" for="x_kd_agama" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_agama->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_agama->CellAttributes() ?>>
...
<?php if ($personal->tgl_masuk->Visible) { // tgl_masuk ?>
	<div id="r_tgl_masuk" class="form-group">
		<label id="elh_personal_tgl_masuk" for="x_tgl_masuk" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_masuk->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_masuk->CellAttributes() ?>>
...
<?php if ($personal->tpt_masuk->Visible) { // tpt_masuk ?>
	<div id="r_tpt_masuk" class="form-group">
		<label id="elh_personal_tpt_masuk" for="x_tpt_masuk" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tpt_masuk->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tpt_masuk->CellAttributes() ?>>
...
<?php if ($personal->stkel->Visible) { // stkel ?>
	<div id="r_stkel" class="form-group">
		<label id="elh_personal_stkel" for="x_stkel" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->stkel->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->stkel->CellAttributes() ?>>
...
<?php if ($personal->alamat->Visible) { // alamat ?>
	<div id="r_alamat" class="form-group">
		<label id="elh_personal_alamat" for="x_alamat" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->alamat->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->alamat->CellAttributes() ?>>
...
<?php if ($personal->kota->Visible) { // kota ?>
	<div id="r_kota" class="form-group">
		<label id="elh_personal_kota" for="x_kota" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kota->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kota->CellAttributes() ?>>
...
<?php if ($personal->kd_pos->Visible) { // kd_pos ?>
	<div id="r_kd_pos" class="form-group">
		<label id="elh_personal_kd_pos" for="x_kd_pos" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_pos->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_pos->CellAttributes() ?>>
...
<?php if ($personal->kd_propinsi->Visible) { // kd_propinsi ?>
	<div id="r_kd_propinsi" class="form-group">
		<label id="elh_personal_kd_propinsi" for="x_kd_propinsi" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_propinsi->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_propinsi->CellAttributes() ?>>
...
<?php if ($personal->telp->Visible) { // telp ?>
	<div id="r_telp" class="form-group">
		<label id="elh_personal_telp" for="x_telp" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->telp->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->telp->CellAttributes() ?>>
...
<?php if ($personal->telp_area->Visible) { // telp_area ?>
	<div id="r_telp_area" class="form-group">
		<label id="elh_personal_telp_area" for="x_telp_area" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->telp_area->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->telp_area->CellAttributes() ?>>
...
<?php if ($personal->hp->Visible) { // hp ?>
	<div id="r_hp" class="form-group">
		<label id="elh_personal_hp" for="x_hp" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->hp->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->hp->CellAttributes() ?>>
...
<?php if ($personal->alamat_dom->Visible) { // alamat_dom ?>
	<div id="r_alamat_dom" class="form-group">
		<label id="elh_personal_alamat_dom" for="x_alamat_dom" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->alamat_dom->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->alamat_dom->CellAttributes() ?>>
...
<?php if ($personal->kota_dom->Visible) { // kota_dom ?>
	<div id="r_kota_dom" class="form-group">
		<label id="elh_personal_kota_dom" for="x_kota_dom" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kota_dom->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kota_dom->CellAttributes() ?>>
...
<?php if ($personal->kd_pos_dom->Visible) { // kd_pos_dom ?>
	<div id="r_kd_pos_dom" class="form-group">
		<label id="elh_personal_kd_pos_dom" for="x_kd_pos_dom" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_pos_dom->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_pos_dom->CellAttributes() ?>>
...
<?php if ($personal->kd_propinsi_dom->Visible) { // kd_propinsi_dom ?>
	<div id="r_kd_propinsi_dom" class="form-group">
		<label id="elh_personal_kd_propinsi_dom" for="x_kd_propinsi_dom" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_propinsi_dom->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_propinsi_dom->CellAttributes() ?>>
...
<?php if ($personal->telp_dom->Visible) { // telp_dom ?>
	<div id="r_telp_dom" class="form-group">
		<label id="elh_personal_telp_dom" for="x_telp_dom" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->telp_dom->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->telp_dom->CellAttributes() ?>>
...
<?php if ($personal->telp_dom_area->Visible) { // telp_dom_area ?>
	<div id="r_telp_dom_area" class="form-group">
		<label id="elh_personal_telp_dom_area" for="x_telp_dom_area" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->telp_dom_area->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->telp_dom_area->CellAttributes() ?>>
...
<?php if ($personal->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_personal__email" for="x__email" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->_email->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->_email->CellAttributes() ?>>
...
<?php if ($personal->kd_st_emp->Visible) { // kd_st_emp ?>
	<div id="r_kd_st_emp" class="form-group">
		<label id="elh_personal_kd_st_emp" for="x_kd_st_emp" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_st_emp->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_st_emp->CellAttributes() ?>>
...
<?php if ($personal->skala->Visible) { // skala ?>
	<div id="r_skala" class="form-group">
		<label id="elh_personal_skala" for="x_skala" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->skala->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->skala->CellAttributes() ?>>
...
<?php if ($personal->gp->Visible) { // gp ?>
	<div id="r_gp" class="form-group">
		<label id="elh_personal_gp" for="x_gp" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->gp->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->gp->CellAttributes() ?>>
...
<?php if ($personal->upah_tetap->Visible) { // upah_tetap ?>
	<div id="r_upah_tetap" class="form-group">
		<label id="elh_personal_upah_tetap" for="x_upah_tetap" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->upah_tetap->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->upah_tetap->CellAttributes() ?>>
...
<?php if ($personal->tgl_honor->Visible) { // tgl_honor ?>
	<div id="r_tgl_honor" class="form-group">
		<label id="elh_personal_tgl_honor" for="x_tgl_honor" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_honor->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_honor->CellAttributes() ?>>
...
<?php if ($personal->honor->Visible) { // honor ?>
	<div id="r_honor" class="form-group">
		<label id="elh_personal_honor" for="x_honor" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->honor->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->honor->CellAttributes() ?>>
...
<?php if ($personal->premi_honor->Visible) { // premi_honor ?>
	<div id="r_premi_honor" class="form-group">
		<label id="elh_personal_premi_honor" for="x_premi_honor" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->premi_honor->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->premi_honor->CellAttributes() ?>>
...
<?php if ($personal->tgl_gp->Visible) { // tgl_gp ?>
	<div id="r_tgl_gp" class="form-group">
		<label id="elh_personal_tgl_gp" for="x_tgl_gp" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_gp->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_gp->CellAttributes() ?>>
...
<?php if ($personal->skala_95->Visible) { // skala_95 ?>
	<div id="r_skala_95" class="form-group">
		<label id="elh_personal_skala_95" for="x_skala_95" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->skala_95->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->skala_95->CellAttributes() ?>>
...
<?php if ($personal->gp_95->Visible) { // gp_95 ?>
	<div id="r_gp_95" class="form-group">
		<label id="elh_personal_gp_95" for="x_gp_95" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->gp_95->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->gp_95->CellAttributes() ?>>
...
<?php if ($personal->tgl_gp_95->Visible) { // tgl_gp_95 ?>
	<div id="r_tgl_gp_95" class="form-group">
		<label id="elh_personal_tgl_gp_95" for="x_tgl_gp_95" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_gp_95->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_gp_95->CellAttributes() ?>>
...
<?php if ($personal->kd_indx->Visible) { // kd_indx ?>
	<div id="r_kd_indx" class="form-group">
		<label id="elh_personal_kd_indx" for="x_kd_indx" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_indx->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_indx->CellAttributes() ?>>
...
<?php if ($personal->indx_lok->Visible) { // indx_lok ?>
	<div id="r_indx_lok" class="form-group">
		<label id="elh_personal_indx_lok" for="x_indx_lok" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->indx_lok->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->indx_lok->CellAttributes() ?>>
...
<?php if ($personal->gol_darah->Visible) { // gol_darah ?>
	<div id="r_gol_darah" class="form-group">
		<label id="elh_personal_gol_darah" for="x_gol_darah" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->gol_darah->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->gol_darah->CellAttributes() ?>>
...
<?php if ($personal->kd_jbt->Visible) { // kd_jbt ?>
	<div id="r_kd_jbt" class="form-group">
		<label id="elh_personal_kd_jbt" for="x_kd_jbt" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_jbt->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_jbt->CellAttributes() ?>>
...
<?php if ($personal->tgl_kd_jbt->Visible) { // tgl_kd_jbt ?>
	<div id="r_tgl_kd_jbt" class="form-group">
		<label id="elh_personal_tgl_kd_jbt" for="x_tgl_kd_jbt" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_kd_jbt->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_kd_jbt->CellAttributes() ?>>
...
<?php if ($personal->kd_jbt_pgs->Visible) { // kd_jbt_pgs ?>
	<div id="r_kd_jbt_pgs" class="form-group">
		<label id="elh_personal_kd_jbt_pgs" for="x_kd_jbt_pgs" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_jbt_pgs->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_jbt_pgs->CellAttributes() ?>>
...
<?php if ($personal->tgl_kd_jbt_pgs->Visible) { // tgl_kd_jbt_pgs ?>
	<div id="r_tgl_kd_jbt_pgs" class="form-group">
		<label id="elh_personal_tgl_kd_jbt_pgs" for="x_tgl_kd_jbt_pgs" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_kd_jbt_pgs->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_kd_jbt_pgs->CellAttributes() ?>>
...
<?php if ($personal->kd_jbt_pjs->Visible) { // kd_jbt_pjs ?>
	<div id="r_kd_jbt_pjs" class="form-group">
		<label id="elh_personal_kd_jbt_pjs" for="x_kd_jbt_pjs" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_jbt_pjs->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_jbt_pjs->CellAttributes() ?>>
...
<?php if ($personal->tgl_kd_jbt_pjs->Visible) { // tgl_kd_jbt_pjs ?>
	<div id="r_tgl_kd_jbt_pjs" class="form-group">
		<label id="elh_personal_tgl_kd_jbt_pjs" for="x_tgl_kd_jbt_pjs" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_kd_jbt_pjs->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_kd_jbt_pjs->CellAttributes() ?>>
...
<?php if ($personal->kd_jbt_ps->Visible) { // kd_jbt_ps ?>
	<div id="r_kd_jbt_ps" class="form-group">
		<label id="elh_personal_kd_jbt_ps" for="x_kd_jbt_ps" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_jbt_ps->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_jbt_ps->CellAttributes() ?>>
...
<?php if ($personal->tgl_kd_jbt_ps->Visible) { // tgl_kd_jbt_ps ?>
	<div id="r_tgl_kd_jbt_ps" class="form-group">
		<label id="elh_personal_tgl_kd_jbt_ps" for="x_tgl_kd_jbt_ps" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_kd_jbt_ps->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_kd_jbt_ps->CellAttributes() ?>>
...
<?php if ($personal->kd_pat->Visible) { // kd_pat ?>
	<div id="r_kd_pat" class="form-group">
		<label id="elh_personal_kd_pat" for="x_kd_pat" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_pat->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_pat->CellAttributes() ?>>
...
<?php if ($personal->kd_gas->Visible) { // kd_gas ?>
	<div id="r_kd_gas" class="form-group">
		<label id="elh_personal_kd_gas" for="x_kd_gas" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_gas->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_gas->CellAttributes() ?>>
...
<?php if ($personal->pimp_empid->Visible) { // pimp_empid ?>
	<div id="r_pimp_empid" class="form-group">
		<label id="elh_personal_pimp_empid" for="x_pimp_empid" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->pimp_empid->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->pimp_empid->CellAttributes() ?>>
...
<?php if ($personal->stshift->Visible) { // stshift ?>
	<div id="r_stshift" class="form-group">
		<label id="elh_personal_stshift" for="x_stshift" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->stshift->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->stshift->CellAttributes() ?>>
...
<?php if ($personal->no_rek->Visible) { // no_rek ?>
	<div id="r_no_rek" class="form-group">
		<label id="elh_personal_no_rek" for="x_no_rek" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->no_rek->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->no_rek->CellAttributes() ?>>
...
<?php if ($personal->kd_bank->Visible) { // kd_bank ?>
	<div id="r_kd_bank" class="form-group">
		<label id="elh_personal_kd_bank" for="x_kd_bank" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_bank->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_bank->CellAttributes() ?>>
...
<?php if ($personal->kd_jamsostek->Visible) { // kd_jamsostek ?>
	<div id="r_kd_jamsostek" class="form-group">
		<label id="elh_personal_kd_jamsostek" for="x_kd_jamsostek" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_jamsostek->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_jamsostek->CellAttributes() ?>>
...
<?php if ($personal->acc_astek->Visible) { // acc_astek ?>
	<div id="r_acc_astek" class="form-group">
		<label id="elh_personal_acc_astek" for="x_acc_astek" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->acc_astek->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->acc_astek->CellAttributes() ?>>
...
<?php if ($personal->acc_dapens->Visible) { // acc_dapens ?>
	<div id="r_acc_dapens" class="form-group">
		<label id="elh_personal_acc_dapens" for="x_acc_dapens" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->acc_dapens->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->acc_dapens->CellAttributes() ?>>
...
<?php if ($personal->acc_kes->Visible) { // acc_kes ?>
	<div id="r_acc_kes" class="form-group">
		<label id="elh_personal_acc_kes" for="x_acc_kes" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->acc_kes->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->acc_kes->CellAttributes() ?>>
...
<?php if ($personal->st->Visible) { // st ?>
	<div id="r_st" class="form-group">
		<label id="elh_personal_st" for="x_st" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->st->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->st->CellAttributes() ?>>
...
<?php if ($personal->signature->Visible) { // signature ?>
	<div id="r_signature" class="form-group">
		<label id="elh_personal_signature" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->signature->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->signature->CellAttributes() ?>>
...
<?php if ($personal->created_by->Visible) { // created_by ?>
	<div id="r_created_by" class="form-group">
		<label id="elh_personal_created_by" for="x_created_by" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->created_by->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->created_by->CellAttributes() ?>>
...
<?php if ($personal->created_date->Visible) { // created_date ?>
	<div id="r_created_date" class="form-group">
		<label id="elh_personal_created_date" for="x_created_date" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->created_date->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->created_date->CellAttributes() ?>>
...
<?php if ($personal->last_update_by->Visible) { // last_update_by ?>
	<div id="r_last_update_by" class="form-group">
		<label id="elh_personal_last_update_by" for="x_last_update_by" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->last_update_by->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->last_update_by->CellAttributes() ?>>
...
<?php if ($personal->last_update_date->Visible) { // last_update_date ?>
	<div id="r_last_update_date" class="form-group">
		<label id="elh_personal_last_update_date" for="x_last_update_date" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->last_update_date->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->last_update_date->CellAttributes() ?>>
...
<?php if ($personal->fgr_print_id->Visible) { // fgr_print_id ?>
	<div id="r_fgr_print_id" class="form-group">
		<label id="elh_personal_fgr_print_id" for="x_fgr_print_id" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->fgr_print_id->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->fgr_print_id->CellAttributes() ?>>
...
<?php if ($personal->kd_jbt_eselon->Visible) { // kd_jbt_eselon ?>
	<div id="r_kd_jbt_eselon" class="form-group">
		<label id="elh_personal_kd_jbt_eselon" for="x_kd_jbt_eselon" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_jbt_eselon->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_jbt_eselon->CellAttributes() ?>>
...
<?php if ($personal->npwp->Visible) { // npwp ?>
	<div id="r_npwp" class="form-group">
		<label id="elh_personal_npwp" for="x_npwp" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->npwp->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->npwp->CellAttributes() ?>>
...
<?php if ($personal->paraf->Visible) { // paraf ?>
	<div id="r_paraf" class="form-group">
		<label id="elh_personal_paraf" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->paraf->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->paraf->CellAttributes() ?>>
...
<?php if ($personal->tgl_keluar->Visible) { // tgl_keluar ?>
	<div id="r_tgl_keluar" class="form-group">
		<label id="elh_personal_tgl_keluar" for="x_tgl_keluar" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_keluar->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_keluar->CellAttributes() ?>>
...
<?php if ($personal->nama_nasabah->Visible) { // nama_nasabah ?>
	<div id="r_nama_nasabah" class="form-group">
		<label id="elh_personal_nama_nasabah" for="x_nama_nasabah" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->nama_nasabah->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->nama_nasabah->CellAttributes() ?>>
...
<?php if ($personal->no_ktp->Visible) { // no_ktp ?>
	<div id="r_no_ktp" class="form-group">
		<label id="elh_personal_no_ktp" for="x_no_ktp" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->no_ktp->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->no_ktp->CellAttributes() ?>>
...
<?php if ($personal->no_kokar->Visible) { // no_kokar ?>
	<div id="r_no_kokar" class="form-group">
		<label id="elh_personal_no_kokar" for="x_no_kokar" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->no_kokar->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->no_kokar->CellAttributes() ?>>
...
<?php if ($personal->no_bmw->Visible) { // no_bmw ?>
	<div id="r_no_bmw" class="form-group">
		<label id="elh_personal_no_bmw" for="x_no_bmw" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->no_bmw->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->no_bmw->CellAttributes() ?>>
...
<?php if ($personal->no_bpjs_ketenagakerjaan->Visible) { // no_bpjs_ketenagakerjaan ?>
	<div id="r_no_bpjs_ketenagakerjaan" class="form-group">
		<label id="elh_personal_no_bpjs_ketenagakerjaan" for="x_no_bpjs_ketenagakerjaan" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->no_bpjs_ketenagakerjaan->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->no_bpjs_ketenagakerjaan->CellAttributes() ?>>
...
<?php if ($personal->no_bpjs_kesehatan->Visible) { // no_bpjs_kesehatan ?>
	<div id="r_no_bpjs_kesehatan" class="form-group">
		<label id="elh_personal_no_bpjs_kesehatan" for="x_no_bpjs_kesehatan" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->no_bpjs_kesehatan->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->no_bpjs_kesehatan->CellAttributes() ?>>
...
<?php if ($personal->eselon->Visible) { // eselon ?>
	<div id="r_eselon" class="form-group">
		<label id="elh_personal_eselon" for="x_eselon" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->eselon->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->eselon->CellAttributes() ?>>
...
<?php if ($personal->kd_jenjang->Visible) { // kd_jenjang ?>
	<div id="r_kd_jenjang" class="form-group">
		<label id="elh_personal_kd_jenjang" for="x_kd_jenjang" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_jenjang->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_jenjang->CellAttributes() ?>>
...
<?php if ($personal->kd_jbt_esl->Visible) { // kd_jbt_esl ?>
	<div id="r_kd_jbt_esl" class="form-group">
		<label id="elh_personal_kd_jbt_esl" for="x_kd_jbt_esl" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_jbt_esl->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_jbt_esl->CellAttributes() ?>>
...
<?php if ($personal->tgl_jbt_esl->Visible) { // tgl_jbt_esl ?>
	<div id="r_tgl_jbt_esl" class="form-group">
		<label id="elh_personal_tgl_jbt_esl" for="x_tgl_jbt_esl" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->tgl_jbt_esl->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->tgl_jbt_esl->CellAttributes() ?>>
...
<?php if ($personal->org_id->Visible) { // org_id ?>
	<div id="r_org_id" class="form-group">
		<label id="elh_personal_org_id" for="x_org_id" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->org_id->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->org_id->CellAttributes() ?>>
...
<?php if ($personal->picture->Visible) { // picture ?>
	<div id="r_picture" class="form-group">
		<label id="elh_personal_picture" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->picture->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->picture->CellAttributes() ?>>
...
<?php if ($personal->kd_payroll->Visible) { // kd_payroll ?>
	<div id="r_kd_payroll" class="form-group">
		<label id="elh_personal_kd_payroll" for="x_kd_payroll" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->kd_payroll->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->kd_payroll->CellAttributes() ?>>
...
<?php if ($personal->id_wn->Visible) { // id_wn ?>
	<div id="r_id_wn" class="form-group">
		<label id="elh_personal_id_wn" for="x_id_wn" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->id_wn->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->id_wn->CellAttributes() ?>>
...
<?php if ($personal->no_anggota_kkms->Visible) { // no_anggota_kkms ?>
	<div id="r_no_anggota_kkms" class="form-group">
		<label id="elh_personal_no_anggota_kkms" for="x_no_anggota_kkms" class="<?php echo $personal_add->LeftColumnClass ?>"><?php echo $personal->no_anggota_kkms->FldCaption() ?></label>
		<div class="<?php echo $personal_add->RightColumnClass ?>"><div<?php echo $personal->no_anggota_kkms->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $personal_add->OffsetColumnClass ?>"><!-- buttons offset -->
