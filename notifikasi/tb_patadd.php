...
$tb_pat_add = NULL; // Initialize page object first

class ctb_pat_add extends ctb_pat {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "tb_patview.php")
...
// Create page object
if (!isset($tb_pat_add)) $tb_pat_add = new ctb_pat_add();

// Page init
$tb_pat_add->Page_Init();

// Page main
$tb_pat_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_pat_add->Page_Render();
?>
...
var CurrentForm = ftb_patadd = new ew_Form("ftb_patadd", "add");

// Validate form
ftb_patadd.Validate = function() {
...
ftb_patadd.Form_CustomValidate = 
...
ftb_patadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $tb_pat_add->ShowPageHeader(); ?>
<?php
$tb_pat_add->ShowMessage();
?>
<form name="ftb_patadd" id="ftb_patadd" class="<?php echo $tb_pat_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_pat_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_pat_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_pat">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($tb_pat_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($tb_pat->KD_PAT->Visible) { // KD_PAT ?>
	<div id="r_KD_PAT" class="form-group">
		<label id="elh_tb_pat_KD_PAT" for="x_KD_PAT" class="<?php echo $tb_pat_add->LeftColumnClass ?>"><?php echo $tb_pat->KD_PAT->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tb_pat_add->RightColumnClass ?>"><div<?php echo $tb_pat->KD_PAT->CellAttributes() ?>>
<span id="el_tb_pat_KD_PAT">
<input type="text" data-table="tb_pat" data-field="x_KD_PAT" name="x_KD_PAT" id="x_KD_PAT" size="30" maxlength="3" placeholder="<?php echo ew_HtmlEncode($tb_pat->KD_PAT->getPlaceHolder()) ?>" value="<?php echo $tb_pat->KD_PAT->EditValue ?>"<?php echo $tb_pat->KD_PAT->EditAttributes() ?>>
</span>
...
<?php if ($tb_pat->KET->Visible) { // KET ?>
	<div id="r_KET" class="form-group">
		<label id="elh_tb_pat_KET" for="x_KET" class="<?php echo $tb_pat_add->LeftColumnClass ?>"><?php echo $tb_pat->KET->FldCaption() ?></label>
		<div class="<?php echo $tb_pat_add->RightColumnClass ?>"><div<?php echo $tb_pat->KET->CellAttributes() ?>>
...
<?php if ($tb_pat->ALAMAT->Visible) { // ALAMAT ?>
	<div id="r_ALAMAT" class="form-group">
		<label id="elh_tb_pat_ALAMAT" for="x_ALAMAT" class="<?php echo $tb_pat_add->LeftColumnClass ?>"><?php echo $tb_pat->ALAMAT->FldCaption() ?></label>
		<div class="<?php echo $tb_pat_add->RightColumnClass ?>"><div<?php echo $tb_pat->ALAMAT->CellAttributes() ?>>
...
<?php if ($tb_pat->KOTA->Visible) { // KOTA ?>
	<div id="r_KOTA" class="form-group">
		<label id="elh_tb_pat_KOTA" for="x_KOTA" class="<?php echo $tb_pat_add->LeftColumnClass ?>"><?php echo $tb_pat->KOTA->FldCaption() ?></label>
		<div class="<?php echo $tb_pat_add->RightColumnClass ?>"><div<?php echo $tb_pat->KOTA->CellAttributes() ?>>
...
<?php if ($tb_pat->SINGKATAN->Visible) { // SINGKATAN ?>
	<div id="r_SINGKATAN" class="form-group">
		<label id="elh_tb_pat_SINGKATAN" for="x_SINGKATAN" class="<?php echo $tb_pat_add->LeftColumnClass ?>"><?php echo $tb_pat->SINGKATAN->FldCaption() ?></label>
		<div class="<?php echo $tb_pat_add->RightColumnClass ?>"><div<?php echo $tb_pat->SINGKATAN->CellAttributes() ?>>
...
<?php if ($tb_pat->CREATED_BY->Visible) { // CREATED_BY ?>
	<div id="r_CREATED_BY" class="form-group">
		<label id="elh_tb_pat_CREATED_BY" for="x_CREATED_BY" class="<?php echo $tb_pat_add->LeftColumnClass ?>"><?php echo $tb_pat->CREATED_BY->FldCaption() ?></label>
		<div class="<?php echo $tb_pat_add->RightColumnClass ?>"><div<?php echo $tb_pat->CREATED_BY->CellAttributes() ?>>
...
<?php if ($tb_pat->CREATED_DATE->Visible) { // CREATED_DATE ?>
	<div id="r_CREATED_DATE" class="form-group">
		<label id="elh_tb_pat_CREATED_DATE" for="x_CREATED_DATE" class="<?php echo $tb_pat_add->LeftColumnClass ?>"><?php echo $tb_pat->CREATED_DATE->FldCaption() ?></label>
		<div class="<?php echo $tb_pat_add->RightColumnClass ?>"><div<?php echo $tb_pat->CREATED_DATE->CellAttributes() ?>>
...
<?php if ($tb_pat->LAST_UPDATE_BY->Visible) { // LAST_UPDATE_BY ?>
	<div id="r_LAST_UPDATE_BY" class="form-group">
		<label id="elh_tb_pat_LAST_UPDATE_BY" for="x_LAST_UPDATE_BY" class="<?php echo $tb_pat_add->LeftColumnClass ?>"><?php echo $tb_pat->LAST_UPDATE_BY->FldCaption() ?></label>
		<div class="<?php echo $tb_pat_add->RightColumnClass ?>"><div<?php echo $tb_pat->LAST_UPDATE_BY->CellAttributes() ?>>
...
<?php if ($tb_pat->LAST_UPDATE_DATE->Visible) { // LAST_UPDATE_DATE ?>
	<div id="r_LAST_UPDATE_DATE" class="form-group">
		<label id="elh_tb_pat_LAST_UPDATE_DATE" for="x_LAST_UPDATE_DATE" class="<?php echo $tb_pat_add->LeftColumnClass ?>"><?php echo $tb_pat->LAST_UPDATE_DATE->FldCaption() ?></label>
		<div class="<?php echo $tb_pat_add->RightColumnClass ?>"><div<?php echo $tb_pat->LAST_UPDATE_DATE->CellAttributes() ?>>
...
<?php if (!$tb_pat_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tb_pat_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tb_pat_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
