...
$rwy_penguasaan_bahasa = NULL;

//
// Table class for rwy_penguasaan_bahasa
//
class crwy_penguasaan_bahasa extends cTable {
	var $id;
	var $nip;
	var $nama_bahasa;
	var $stat_validasi;
	...
	function __construct() {
		...
		$this->TableVar = 'rwy_penguasaan_bahasa';
		$this->TableName = 'rwy_penguasaan_bahasa';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`rwy_penguasaan_bahasa`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('rwy_penguasaan_bahasa', 'rwy_penguasaan_bahasa', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// nip
		$this->nip = new cField('rwy_penguasaan_bahasa', 'rwy_penguasaan_bahasa', 'x_nip', 'nip', '`nip`', '`nip`', 200, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip->Sortable = TRUE; // Allow sort
		$this->fields['nip'] = &$this->nip;

		// nama_bahasa
		$this->nama_bahasa = new cField('rwy_penguasaan_bahasa', 'rwy_penguasaan_bahasa', 'x_nama_bahasa', 'nama_bahasa', '`nama_bahasa`', '`nama_bahasa`', 200, -1, FALSE, '`nama_bahasa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_bahasa->Sortable = TRUE; // Allow sort
		$this->fields['nama_bahasa'] = &$this->nama_bahasa;

		// stat_validasi
		$this->stat_validasi = new cField('rwy_penguasaan_bahasa', 'rwy_penguasaan_bahasa', 'x_stat_validasi', 'stat_validasi', '`stat_validasi`', '`stat_validasi`', 3, -1, FALSE, '`stat_validasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// change_date
		$this->change_date = new cField('rwy_penguasaan_bahasa', 'rwy_penguasaan_bahasa', 'x_change_date', 'change_date', '`change_date`', ew_CastDateFieldForLike('`change_date`', 0, "DB"), 135, 0, FALSE, '`change_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// change_by
		$this->change_by = new cField('rwy_penguasaan_bahasa', 'rwy_penguasaan_bahasa', 'x_change_by', 'change_by', '`change_by`', '`change_by`', 200, -1, FALSE, '`change_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`rwy_penguasaan_bahasa`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "rwy_penguasaan_bahasalist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "rwy_penguasaan_bahasaedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "rwy_penguasaan_bahasaadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("rwy_penguasaan_bahasaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("rwy_penguasaan_bahasaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "rwy_penguasaan_bahasaadd.php?" . $this->UrlParm($parm);
		else
			$url = "rwy_penguasaan_bahasaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("rwy_penguasaan_bahasaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("rwy_penguasaan_bahasaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("rwy_penguasaan_bahasadelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->nama_bahasa->setDbValue($rs->fields('nama_bahasa'));
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->nama_bahasa->Exportable) $Doc->ExportCaption($this->nama_bahasa);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->nama_bahasa->Exportable) $Doc->ExportField($this->nama_bahasa);
