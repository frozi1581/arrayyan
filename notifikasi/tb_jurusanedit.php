...
$tb_jurusan_edit = NULL; // Initialize page object first

class ctb_jurusan_edit extends ctb_jurusan {
	...
	// Page object name
	var $PageObjName = 'tb_jurusan_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_kd_jurusan")) {
...
// Create page object
if (!isset($tb_jurusan_edit)) $tb_jurusan_edit = new ctb_jurusan_edit();

// Page init
$tb_jurusan_edit->Page_Init();

// Page main
$tb_jurusan_edit->Page_Main();
...
var CurrentForm = ftb_jurusanedit = new ew_Form("ftb_jurusanedit", "edit");
...
ftb_jurusanedit.Form_CustomValidate = 
...
ftb_jurusanedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="ftb_jurusanedit" id="ftb_jurusanedit" class="<?php echo $tb_jurusan_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_jurusan_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_jurusan_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_jurusan">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tb_jurusan_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($tb_jurusan->kd_jurusan->Visible) { // kd_jurusan ?>
	<div id="r_kd_jurusan" class="form-group">
		<label id="elh_tb_jurusan_kd_jurusan" for="x_kd_jurusan" class="<?php echo $tb_jurusan_edit->LeftColumnClass ?>"><?php echo $tb_jurusan->kd_jurusan->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tb_jurusan_edit->RightColumnClass ?>"><div<?php echo $tb_jurusan->kd_jurusan->CellAttributes() ?>>
<span id="el_tb_jurusan_kd_jurusan">
<span<?php echo $tb_jurusan->kd_jurusan->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $tb_jurusan->kd_jurusan->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tb_jurusan" data-field="x_kd_jurusan" name="x_kd_jurusan" id="x_kd_jurusan" value="<?php echo ew_HtmlEncode($tb_jurusan->kd_jurusan->CurrentValue) ?>">
<?php echo $tb_jurusan->kd_jurusan->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($tb_jurusan->ket->Visible) { // ket ?>
	<div id="r_ket" class="form-group">
		<label id="elh_tb_jurusan_ket" for="x_ket" class="<?php echo $tb_jurusan_edit->LeftColumnClass ?>"><?php echo $tb_jurusan->ket->FldCaption() ?></label>
		<div class="<?php echo $tb_jurusan_edit->RightColumnClass ?>"><div<?php echo $tb_jurusan->ket->CellAttributes() ?>>
...
<?php if ($tb_jurusan->created_by->Visible) { // created_by ?>
	<div id="r_created_by" class="form-group">
		<label id="elh_tb_jurusan_created_by" for="x_created_by" class="<?php echo $tb_jurusan_edit->LeftColumnClass ?>"><?php echo $tb_jurusan->created_by->FldCaption() ?></label>
		<div class="<?php echo $tb_jurusan_edit->RightColumnClass ?>"><div<?php echo $tb_jurusan->created_by->CellAttributes() ?>>
...
<?php if ($tb_jurusan->created_date->Visible) { // created_date ?>
	<div id="r_created_date" class="form-group">
		<label id="elh_tb_jurusan_created_date" for="x_created_date" class="<?php echo $tb_jurusan_edit->LeftColumnClass ?>"><?php echo $tb_jurusan->created_date->FldCaption() ?></label>
		<div class="<?php echo $tb_jurusan_edit->RightColumnClass ?>"><div<?php echo $tb_jurusan->created_date->CellAttributes() ?>>
...
<?php if ($tb_jurusan->last_update_by->Visible) { // last_update_by ?>
	<div id="r_last_update_by" class="form-group">
		<label id="elh_tb_jurusan_last_update_by" for="x_last_update_by" class="<?php echo $tb_jurusan_edit->LeftColumnClass ?>"><?php echo $tb_jurusan->last_update_by->FldCaption() ?></label>
		<div class="<?php echo $tb_jurusan_edit->RightColumnClass ?>"><div<?php echo $tb_jurusan->last_update_by->CellAttributes() ?>>
...
<?php if ($tb_jurusan->last_update_date->Visible) { // last_update_date ?>
	<div id="r_last_update_date" class="form-group">
		<label id="elh_tb_jurusan_last_update_date" for="x_last_update_date" class="<?php echo $tb_jurusan_edit->LeftColumnClass ?>"><?php echo $tb_jurusan->last_update_date->FldCaption() ?></label>
		<div class="<?php echo $tb_jurusan_edit->RightColumnClass ?>"><div<?php echo $tb_jurusan->last_update_date->CellAttributes() ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tb_jurusan_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
ftb_jurusanedit.Init();
</script>
<?php
...
<?php
$tb_jurusan_edit->Page_Terminate();
?>
