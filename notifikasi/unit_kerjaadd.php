...
$unit_kerja_add = NULL; // Initialize page object first

class cunit_kerja_add extends cunit_kerja {
	...
	// Page object name
	var $PageObjName = 'unit_kerja_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "unit_kerjaview.php")
	...
	function LoadDefaultValues() {
		...
		$this->nama_unit_kerja->CurrentValue = NULL;
		$this->nama_unit_kerja->OldValue = $this->nama_unit_kerja->CurrentValue;
	...
	function NewRow() {
		...
		$row['nama_unit_kerja'] = $this->nama_unit_kerja->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->kode_unit_kerja->CurrentValue <> "") { // Check field with unique index
			$sFilter = "(kode_unit_kerja = '" . ew_AdjustSql($this->kode_unit_kerja->CurrentValue, $this->DBID) . "')";
		...
		// nama_unit_kerja
		$this->nama_unit_kerja->SetDbValueDef($rsnew, $this->nama_unit_kerja->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($unit_kerja_add)) $unit_kerja_add = new cunit_kerja_add();

// Page init
$unit_kerja_add->Page_Init();

// Page main
$unit_kerja_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$unit_kerja_add->Page_Render();
?>
...
var CurrentForm = funit_kerjaadd = new ew_Form("funit_kerjaadd", "add");

// Validate form
funit_kerjaadd.Validate = function() {
...
funit_kerjaadd.Form_CustomValidate = 
...
funit_kerjaadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $unit_kerja_add->ShowPageHeader(); ?>
<?php
$unit_kerja_add->ShowMessage();
?>
<form name="funit_kerjaadd" id="funit_kerjaadd" class="<?php echo $unit_kerja_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($unit_kerja_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $unit_kerja_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="unit_kerja">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($unit_kerja_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($unit_kerja->kode_unit_organisasi->Visible) { // kode_unit_organisasi ?>
	<div id="r_kode_unit_organisasi" class="form-group">
		<label id="elh_unit_kerja_kode_unit_organisasi" for="x_kode_unit_organisasi" class="<?php echo $unit_kerja_add->LeftColumnClass ?>"><?php echo $unit_kerja->kode_unit_organisasi->FldCaption() ?></label>
		<div class="<?php echo $unit_kerja_add->RightColumnClass ?>"><div<?php echo $unit_kerja->kode_unit_organisasi->CellAttributes() ?>>
...
<?php if ($unit_kerja->kode_unit_kerja->Visible) { // kode_unit_kerja ?>
	<div id="r_kode_unit_kerja" class="form-group">
		<label id="elh_unit_kerja_kode_unit_kerja" for="x_kode_unit_kerja" class="<?php echo $unit_kerja_add->LeftColumnClass ?>"><?php echo $unit_kerja->kode_unit_kerja->FldCaption() ?></label>
		<div class="<?php echo $unit_kerja_add->RightColumnClass ?>"><div<?php echo $unit_kerja->kode_unit_kerja->CellAttributes() ?>>
...
<?php if ($unit_kerja->nama_unit_kerja->Visible) { // nama_unit_kerja ?>
	<div id="r_nama_unit_kerja" class="form-group">
		<label id="elh_unit_kerja_nama_unit_kerja" for="x_nama_unit_kerja" class="<?php echo $unit_kerja_add->LeftColumnClass ?>"><?php echo $unit_kerja->nama_unit_kerja->FldCaption() ?></label>
		<div class="<?php echo $unit_kerja_add->RightColumnClass ?>"><div<?php echo $unit_kerja->nama_unit_kerja->CellAttributes() ?>>
...
<?php if ($unit_kerja->change_by->Visible) { // change_by ?>
	<div id="r_change_by" class="form-group">
		<label id="elh_unit_kerja_change_by" for="x_change_by" class="<?php echo $unit_kerja_add->LeftColumnClass ?>"><?php echo $unit_kerja->change_by->FldCaption() ?></label>
		<div class="<?php echo $unit_kerja_add->RightColumnClass ?>"><div<?php echo $unit_kerja->change_by->CellAttributes() ?>>
...
<?php if ($unit_kerja->change_date->Visible) { // change_date ?>
	<div id="r_change_date" class="form-group">
		<label id="elh_unit_kerja_change_date" for="x_change_date" class="<?php echo $unit_kerja_add->LeftColumnClass ?>"><?php echo $unit_kerja->change_date->FldCaption() ?></label>
		<div class="<?php echo $unit_kerja_add->RightColumnClass ?>"><div<?php echo $unit_kerja->change_date->CellAttributes() ?>>
...
<?php if (!$unit_kerja_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $unit_kerja_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $unit_kerja_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
