...
$rwy_bidang_keahlian_edit = NULL; // Initialize page object first

class crwy_bidang_keahlian_edit extends crwy_bidang_keahlian {
	...
	// Page object name
	var $PageObjName = 'rwy_bidang_keahlian_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// nama_bidang
			$this->nama_bidang->SetDbValueDef($rsnew, $this->nama_bidang->CurrentValue, NULL, $this->nama_bidang->ReadOnly);
...
// Create page object
if (!isset($rwy_bidang_keahlian_edit)) $rwy_bidang_keahlian_edit = new crwy_bidang_keahlian_edit();

// Page init
$rwy_bidang_keahlian_edit->Page_Init();

// Page main
$rwy_bidang_keahlian_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rwy_bidang_keahlian_edit->Page_Render();
?>
...
var CurrentForm = frwy_bidang_keahlianedit = new ew_Form("frwy_bidang_keahlianedit", "edit");

// Validate form
frwy_bidang_keahlianedit.Validate = function() {
...
frwy_bidang_keahlianedit.Form_CustomValidate = 
...
frwy_bidang_keahlianedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $rwy_bidang_keahlian_edit->ShowPageHeader(); ?>
<?php
$rwy_bidang_keahlian_edit->ShowMessage();
?>
<form name="frwy_bidang_keahlianedit" id="frwy_bidang_keahlianedit" class="<?php echo $rwy_bidang_keahlian_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rwy_bidang_keahlian_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rwy_bidang_keahlian_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rwy_bidang_keahlian">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($rwy_bidang_keahlian_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($rwy_bidang_keahlian->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_rwy_bidang_keahlian_id" class="<?php echo $rwy_bidang_keahlian_edit->LeftColumnClass ?>"><?php echo $rwy_bidang_keahlian->id->FldCaption() ?></label>
		<div class="<?php echo $rwy_bidang_keahlian_edit->RightColumnClass ?>"><div<?php echo $rwy_bidang_keahlian->id->CellAttributes() ?>>
<span id="el_rwy_bidang_keahlian_id">
<span<?php echo $rwy_bidang_keahlian->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $rwy_bidang_keahlian->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="rwy_bidang_keahlian" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($rwy_bidang_keahlian->id->CurrentValue) ?>">
<?php echo $rwy_bidang_keahlian->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($rwy_bidang_keahlian->nip->Visible) { // nip ?>
	<div id="r_nip" class="form-group">
		<label id="elh_rwy_bidang_keahlian_nip" for="x_nip" class="<?php echo $rwy_bidang_keahlian_edit->LeftColumnClass ?>"><?php echo $rwy_bidang_keahlian->nip->FldCaption() ?></label>
		<div class="<?php echo $rwy_bidang_keahlian_edit->RightColumnClass ?>"><div<?php echo $rwy_bidang_keahlian->nip->CellAttributes() ?>>
...
<?php if ($rwy_bidang_keahlian->nama_bidang->Visible) { // nama_bidang ?>
	<div id="r_nama_bidang" class="form-group">
		<label id="elh_rwy_bidang_keahlian_nama_bidang" for="x_nama_bidang" class="<?php echo $rwy_bidang_keahlian_edit->LeftColumnClass ?>"><?php echo $rwy_bidang_keahlian->nama_bidang->FldCaption() ?></label>
		<div class="<?php echo $rwy_bidang_keahlian_edit->RightColumnClass ?>"><div<?php echo $rwy_bidang_keahlian->nama_bidang->CellAttributes() ?>>
...
<?php if ($rwy_bidang_keahlian->keterangan->Visible) { // keterangan ?>
	<div id="r_keterangan" class="form-group">
		<label id="elh_rwy_bidang_keahlian_keterangan" for="x_keterangan" class="<?php echo $rwy_bidang_keahlian_edit->LeftColumnClass ?>"><?php echo $rwy_bidang_keahlian->keterangan->FldCaption() ?></label>
		<div class="<?php echo $rwy_bidang_keahlian_edit->RightColumnClass ?>"><div<?php echo $rwy_bidang_keahlian->keterangan->CellAttributes() ?>>
...
<?php if ($rwy_bidang_keahlian->stat_validasi->Visible) { // stat_validasi ?>
	<div id="r_stat_validasi" class="form-group">
		<label id="elh_rwy_bidang_keahlian_stat_validasi" for="x_stat_validasi" class="<?php echo $rwy_bidang_keahlian_edit->LeftColumnClass ?>"><?php echo $rwy_bidang_keahlian->stat_validasi->FldCaption() ?></label>
		<div class="<?php echo $rwy_bidang_keahlian_edit->RightColumnClass ?>"><div<?php echo $rwy_bidang_keahlian->stat_validasi->CellAttributes() ?>>
...
<?php if ($rwy_bidang_keahlian->change_date->Visible) { // change_date ?>
	<div id="r_change_date" class="form-group">
		<label id="elh_rwy_bidang_keahlian_change_date" for="x_change_date" class="<?php echo $rwy_bidang_keahlian_edit->LeftColumnClass ?>"><?php echo $rwy_bidang_keahlian->change_date->FldCaption() ?></label>
		<div class="<?php echo $rwy_bidang_keahlian_edit->RightColumnClass ?>"><div<?php echo $rwy_bidang_keahlian->change_date->CellAttributes() ?>>
...
<?php if ($rwy_bidang_keahlian->change_by->Visible) { // change_by ?>
	<div id="r_change_by" class="form-group">
		<label id="elh_rwy_bidang_keahlian_change_by" for="x_change_by" class="<?php echo $rwy_bidang_keahlian_edit->LeftColumnClass ?>"><?php echo $rwy_bidang_keahlian->change_by->FldCaption() ?></label>
		<div class="<?php echo $rwy_bidang_keahlian_edit->RightColumnClass ?>"><div<?php echo $rwy_bidang_keahlian->change_by->CellAttributes() ?>>
...
<?php if (!$rwy_bidang_keahlian_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $rwy_bidang_keahlian_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rwy_bidang_keahlian_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
frwy_bidang_keahlianedit.Init();
</script>
<?php
$rwy_bidang_keahlian_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rwy_bidang_keahlian_edit->Page_Terminate();
?>
