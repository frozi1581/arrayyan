...
$ciri_ciri_jasmani_edit = NULL; // Initialize page object first

class cciri_ciri_jasmani_edit extends cciri_ciri_jasmani {
	...
	// Page object name
	var $PageObjName = 'ciri_ciri_jasmani_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// tinggi_badan
			$this->tinggi_badan->SetDbValueDef($rsnew, $this->tinggi_badan->CurrentValue, NULL, $this->tinggi_badan->ReadOnly);

			// berat
			$this->berat->SetDbValueDef($rsnew, $this->berat->CurrentValue, NULL, $this->berat->ReadOnly);

			// bentuk_hidung
			$this->bentuk_hidung->SetDbValueDef($rsnew, $this->bentuk_hidung->CurrentValue, NULL, $this->bentuk_hidung->ReadOnly);

			// bentuk_muka
			$this->bentuk_muka->SetDbValueDef($rsnew, $this->bentuk_muka->CurrentValue, NULL, $this->bentuk_muka->ReadOnly);

			// warna_kulit
			$this->warna_kulit->SetDbValueDef($rsnew, $this->warna_kulit->CurrentValue, NULL, $this->warna_kulit->ReadOnly);

			// warna_rambut
			$this->warna_rambut->SetDbValueDef($rsnew, $this->warna_rambut->CurrentValue, NULL, $this->warna_rambut->ReadOnly);

			// hobi
			$this->hobi->SetDbValueDef($rsnew, $this->hobi->CurrentValue, NULL, $this->hobi->ReadOnly);
...
// Create page object
if (!isset($ciri_ciri_jasmani_edit)) $ciri_ciri_jasmani_edit = new cciri_ciri_jasmani_edit();

// Page init
$ciri_ciri_jasmani_edit->Page_Init();

// Page main
$ciri_ciri_jasmani_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ciri_ciri_jasmani_edit->Page_Render();
?>
...
var CurrentForm = fciri_ciri_jasmaniedit = new ew_Form("fciri_ciri_jasmaniedit", "edit");

// Validate form
fciri_ciri_jasmaniedit.Validate = function() {
...
fciri_ciri_jasmaniedit.Form_CustomValidate = 
...
fciri_ciri_jasmaniedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $ciri_ciri_jasmani_edit->ShowPageHeader(); ?>
<?php
$ciri_ciri_jasmani_edit->ShowMessage();
?>
<form name="fciri_ciri_jasmaniedit" id="fciri_ciri_jasmaniedit" class="<?php echo $ciri_ciri_jasmani_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ciri_ciri_jasmani_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ciri_ciri_jasmani_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="ciri_ciri_jasmani">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($ciri_ciri_jasmani_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($ciri_ciri_jasmani->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_ciri_ciri_jasmani_id" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->id->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->id->CellAttributes() ?>>
<span id="el_ciri_ciri_jasmani_id">
<span<?php echo $ciri_ciri_jasmani->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $ciri_ciri_jasmani->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ciri_ciri_jasmani" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($ciri_ciri_jasmani->id->CurrentValue) ?>">
<?php echo $ciri_ciri_jasmani->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ciri_ciri_jasmani->nip->Visible) { // nip ?>
	<div id="r_nip" class="form-group">
		<label id="elh_ciri_ciri_jasmani_nip" for="x_nip" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->nip->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->nip->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->tinggi_badan->Visible) { // tinggi_badan ?>
	<div id="r_tinggi_badan" class="form-group">
		<label id="elh_ciri_ciri_jasmani_tinggi_badan" for="x_tinggi_badan" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->tinggi_badan->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->tinggi_badan->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->berat->Visible) { // berat ?>
	<div id="r_berat" class="form-group">
		<label id="elh_ciri_ciri_jasmani_berat" for="x_berat" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->berat->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->berat->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->bentuk_hidung->Visible) { // bentuk_hidung ?>
	<div id="r_bentuk_hidung" class="form-group">
		<label id="elh_ciri_ciri_jasmani_bentuk_hidung" for="x_bentuk_hidung" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->bentuk_hidung->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->bentuk_hidung->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->bentuk_muka->Visible) { // bentuk_muka ?>
	<div id="r_bentuk_muka" class="form-group">
		<label id="elh_ciri_ciri_jasmani_bentuk_muka" for="x_bentuk_muka" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->bentuk_muka->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->bentuk_muka->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->warna_kulit->Visible) { // warna_kulit ?>
	<div id="r_warna_kulit" class="form-group">
		<label id="elh_ciri_ciri_jasmani_warna_kulit" for="x_warna_kulit" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->warna_kulit->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->warna_kulit->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->warna_rambut->Visible) { // warna_rambut ?>
	<div id="r_warna_rambut" class="form-group">
		<label id="elh_ciri_ciri_jasmani_warna_rambut" for="x_warna_rambut" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->warna_rambut->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->warna_rambut->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->hobi->Visible) { // hobi ?>
	<div id="r_hobi" class="form-group">
		<label id="elh_ciri_ciri_jasmani_hobi" for="x_hobi" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->hobi->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->hobi->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->stat_validasi->Visible) { // stat_validasi ?>
	<div id="r_stat_validasi" class="form-group">
		<label id="elh_ciri_ciri_jasmani_stat_validasi" for="x_stat_validasi" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->stat_validasi->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->stat_validasi->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->change_date->Visible) { // change_date ?>
	<div id="r_change_date" class="form-group">
		<label id="elh_ciri_ciri_jasmani_change_date" for="x_change_date" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->change_date->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->change_date->CellAttributes() ?>>
...
<?php if ($ciri_ciri_jasmani->change_by->Visible) { // change_by ?>
	<div id="r_change_by" class="form-group">
		<label id="elh_ciri_ciri_jasmani_change_by" for="x_change_by" class="<?php echo $ciri_ciri_jasmani_edit->LeftColumnClass ?>"><?php echo $ciri_ciri_jasmani->change_by->FldCaption() ?></label>
		<div class="<?php echo $ciri_ciri_jasmani_edit->RightColumnClass ?>"><div<?php echo $ciri_ciri_jasmani->change_by->CellAttributes() ?>>
...
<?php if (!$ciri_ciri_jasmani_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $ciri_ciri_jasmani_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ciri_ciri_jasmani_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fciri_ciri_jasmaniedit.Init();
</script>
<?php
$ciri_ciri_jasmani_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ciri_ciri_jasmani_edit->Page_Terminate();
?>
