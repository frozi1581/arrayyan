...
//
// Table class for unit_kerja
//
class cunit_kerja extends cTable {
	var $id;
	...
	function __construct() {
		...
		$this->TableVar = 'unit_kerja';
		$this->TableName = 'unit_kerja';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`unit_kerja`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('unit_kerja', 'unit_kerja', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// kode_unit_organisasi
		$this->kode_unit_organisasi = new cField('unit_kerja', 'unit_kerja', 'x_kode_unit_organisasi', 'kode_unit_organisasi', '`kode_unit_organisasi`', '`kode_unit_organisasi`', 200, -1, FALSE, '`kode_unit_organisasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_unit_organisasi->Sortable = TRUE; // Allow sort
		$this->fields['kode_unit_organisasi'] = &$this->kode_unit_organisasi;

		// kode_unit_kerja
		$this->kode_unit_kerja = new cField('unit_kerja', 'unit_kerja', 'x_kode_unit_kerja', 'kode_unit_kerja', '`kode_unit_kerja`', '`kode_unit_kerja`', 200, -1, FALSE, '`kode_unit_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_unit_kerja->Sortable = TRUE; // Allow sort
		$this->fields['kode_unit_kerja'] = &$this->kode_unit_kerja;

		// nama_unit_kerja
		$this->nama_unit_kerja = new cField('unit_kerja', 'unit_kerja', 'x_nama_unit_kerja', 'nama_unit_kerja', '`nama_unit_kerja`', '`nama_unit_kerja`', 200, -1, FALSE, '`nama_unit_kerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_unit_kerja->Sortable = TRUE; // Allow sort
		$this->fields['nama_unit_kerja'] = &$this->nama_unit_kerja;

		// change_by
		$this->change_by = new cField('unit_kerja', 'unit_kerja', 'x_change_by', 'change_by', '`change_by`', '`change_by`', 200, -1, FALSE, '`change_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->change_by->Sortable = TRUE; // Allow sort
		$this->fields['change_by'] = &$this->change_by;

		// change_date
		$this->change_date = new cField('unit_kerja', 'unit_kerja', 'x_change_date', 'change_date', '`change_date`', ew_CastDateFieldForLike('`change_date`', 0, "DB"), 135, 0, FALSE, '`change_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`unit_kerja`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "unit_kerjaedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "unit_kerjaadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("unit_kerjaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("unit_kerjaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "unit_kerjaadd.php?" . $this->UrlParm($parm);
		else
			$url = "unit_kerjaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("unit_kerjaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("unit_kerjaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("unit_kerjadelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->nama_unit_kerja->setDbValue($rs->fields('nama_unit_kerja'));
	...
	function RenderEditRow() {
		...
		$this->nama_unit_kerja->EditValue = $this->nama_unit_kerja->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->nama_unit_kerja->Exportable) $Doc->ExportCaption($this->nama_unit_kerja);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->nama_unit_kerja->Exportable) $Doc->ExportField($this->nama_unit_kerja);
