...
$rwy_penguasaan_bahasa_edit = NULL; // Initialize page object first

class crwy_penguasaan_bahasa_edit extends crwy_penguasaan_bahasa {
	...
	// Page object name
	var $PageObjName = 'rwy_penguasaan_bahasa_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// nama_bahasa
			$this->nama_bahasa->SetDbValueDef($rsnew, $this->nama_bahasa->CurrentValue, "", $this->nama_bahasa->ReadOnly);

			// stat_validasi
			$this->stat_validasi->SetDbValueDef($rsnew, $this->stat_validasi->CurrentValue, 0, $this->stat_validasi->ReadOnly);

			// change_date
			$this->change_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->change_date->CurrentValue, 0), ew_CurrentDate(), $this->change_date->ReadOnly);
...
// Create page object
if (!isset($rwy_penguasaan_bahasa_edit)) $rwy_penguasaan_bahasa_edit = new crwy_penguasaan_bahasa_edit();

// Page init
$rwy_penguasaan_bahasa_edit->Page_Init();

// Page main
$rwy_penguasaan_bahasa_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rwy_penguasaan_bahasa_edit->Page_Render();
?>
...
var CurrentForm = frwy_penguasaan_bahasaedit = new ew_Form("frwy_penguasaan_bahasaedit", "edit");

// Validate form
frwy_penguasaan_bahasaedit.Validate = function() {
...
frwy_penguasaan_bahasaedit.Form_CustomValidate = 
...
frwy_penguasaan_bahasaedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $rwy_penguasaan_bahasa_edit->ShowPageHeader(); ?>
<?php
$rwy_penguasaan_bahasa_edit->ShowMessage();
?>
<form name="frwy_penguasaan_bahasaedit" id="frwy_penguasaan_bahasaedit" class="<?php echo $rwy_penguasaan_bahasa_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rwy_penguasaan_bahasa_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rwy_penguasaan_bahasa_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rwy_penguasaan_bahasa">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($rwy_penguasaan_bahasa_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($rwy_penguasaan_bahasa->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_rwy_penguasaan_bahasa_id" class="<?php echo $rwy_penguasaan_bahasa_edit->LeftColumnClass ?>"><?php echo $rwy_penguasaan_bahasa->id->FldCaption() ?></label>
		<div class="<?php echo $rwy_penguasaan_bahasa_edit->RightColumnClass ?>"><div<?php echo $rwy_penguasaan_bahasa->id->CellAttributes() ?>>
<span id="el_rwy_penguasaan_bahasa_id">
<span<?php echo $rwy_penguasaan_bahasa->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $rwy_penguasaan_bahasa->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="rwy_penguasaan_bahasa" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($rwy_penguasaan_bahasa->id->CurrentValue) ?>">
<?php echo $rwy_penguasaan_bahasa->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($rwy_penguasaan_bahasa->nip->Visible) { // nip ?>
	<div id="r_nip" class="form-group">
		<label id="elh_rwy_penguasaan_bahasa_nip" for="x_nip" class="<?php echo $rwy_penguasaan_bahasa_edit->LeftColumnClass ?>"><?php echo $rwy_penguasaan_bahasa->nip->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $rwy_penguasaan_bahasa_edit->RightColumnClass ?>"><div<?php echo $rwy_penguasaan_bahasa->nip->CellAttributes() ?>>
...
<?php if ($rwy_penguasaan_bahasa->nama_bahasa->Visible) { // nama_bahasa ?>
	<div id="r_nama_bahasa" class="form-group">
		<label id="elh_rwy_penguasaan_bahasa_nama_bahasa" for="x_nama_bahasa" class="<?php echo $rwy_penguasaan_bahasa_edit->LeftColumnClass ?>"><?php echo $rwy_penguasaan_bahasa->nama_bahasa->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $rwy_penguasaan_bahasa_edit->RightColumnClass ?>"><div<?php echo $rwy_penguasaan_bahasa->nama_bahasa->CellAttributes() ?>>
...
<?php if ($rwy_penguasaan_bahasa->stat_validasi->Visible) { // stat_validasi ?>
	<div id="r_stat_validasi" class="form-group">
		<label id="elh_rwy_penguasaan_bahasa_stat_validasi" for="x_stat_validasi" class="<?php echo $rwy_penguasaan_bahasa_edit->LeftColumnClass ?>"><?php echo $rwy_penguasaan_bahasa->stat_validasi->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $rwy_penguasaan_bahasa_edit->RightColumnClass ?>"><div<?php echo $rwy_penguasaan_bahasa->stat_validasi->CellAttributes() ?>>
...
<?php if ($rwy_penguasaan_bahasa->change_date->Visible) { // change_date ?>
	<div id="r_change_date" class="form-group">
		<label id="elh_rwy_penguasaan_bahasa_change_date" for="x_change_date" class="<?php echo $rwy_penguasaan_bahasa_edit->LeftColumnClass ?>"><?php echo $rwy_penguasaan_bahasa->change_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $rwy_penguasaan_bahasa_edit->RightColumnClass ?>"><div<?php echo $rwy_penguasaan_bahasa->change_date->CellAttributes() ?>>
...
<?php if ($rwy_penguasaan_bahasa->change_by->Visible) { // change_by ?>
	<div id="r_change_by" class="form-group">
		<label id="elh_rwy_penguasaan_bahasa_change_by" for="x_change_by" class="<?php echo $rwy_penguasaan_bahasa_edit->LeftColumnClass ?>"><?php echo $rwy_penguasaan_bahasa->change_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $rwy_penguasaan_bahasa_edit->RightColumnClass ?>"><div<?php echo $rwy_penguasaan_bahasa->change_by->CellAttributes() ?>>
...
<?php if (!$rwy_penguasaan_bahasa_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $rwy_penguasaan_bahasa_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rwy_penguasaan_bahasa_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
frwy_penguasaan_bahasaedit.Init();
</script>
<?php
$rwy_penguasaan_bahasa_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rwy_penguasaan_bahasa_edit->Page_Terminate();
?>
