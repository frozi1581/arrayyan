...
$personal_paraf_blobview = NULL; // Initialize page object first

class cpersonal_paraf_blobview extends cpersonal {
	...
	// Page object name
	var $PageObjName = 'personal_paraf_blobview';
	...
	function Page_Main() {
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('paraf');
...
// Create page object
if (!isset($personal_paraf_blobview)) $personal_paraf_blobview = new cpersonal_paraf_blobview();

// Page init
$personal_paraf_blobview->Page_Init();

// Page main
$personal_paraf_blobview->Page_Main();
?>
<?php
$personal_paraf_blobview->Page_Terminate();
?>
