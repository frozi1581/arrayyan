...
class cpendidikan_edit extends cpendidikan {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->kd_jurusan->SetDbValueDef($rsnew, $this->kd_jurusan->CurrentValue, NULL, $this->kd_jurusan->ReadOnly);

			// kd_lmbg
			$this->kd_lmbg->SetDbValueDef($rsnew, $this->kd_lmbg->CurrentValue, NULL, $this->kd_lmbg->ReadOnly);

			// ipk
			$this->ipk->SetDbValueDef($rsnew, $this->ipk->CurrentValue, NULL, $this->ipk->ReadOnly);

			// ket
			$this->ket->SetDbValueDef($rsnew, $this->ket->CurrentValue, NULL, $this->ket->ReadOnly);

			// th_mulai
			$this->th_mulai->SetDbValueDef($rsnew, $this->th_mulai->CurrentValue, NULL, $this->th_mulai->ReadOnly);

			// th_akhir
			$this->th_akhir->SetDbValueDef($rsnew, $this->th_akhir->CurrentValue, NULL, $this->th_akhir->ReadOnly);
			...
			// upload_ijazah
			$this->upload_ijazah->SetDbValueDef($rsnew, $this->upload_ijazah->CurrentValue, NULL, $this->upload_ijazah->ReadOnly);
...
fpendidikanedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($pendidikan_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($pendidikan->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_pendidikan_id" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->id->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->id->CellAttributes() ?>>
<span id="el_pendidikan_id">
<span<?php echo $pendidikan->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pendidikan->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pendidikan" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($pendidikan->id->CurrentValue) ?>">
<?php echo $pendidikan->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pendidikan->employee_id->Visible) { // employee_id ?>
	<div id="r_employee_id" class="form-group">
		<label id="elh_pendidikan_employee_id" for="x_employee_id" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->employee_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->employee_id->CellAttributes() ?>>
<span id="el_pendidikan_employee_id">
<span<?php echo $pendidikan->employee_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pendidikan->employee_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pendidikan" data-field="x_employee_id" name="x_employee_id" id="x_employee_id" value="<?php echo ew_HtmlEncode($pendidikan->employee_id->CurrentValue) ?>">
...
<?php if ($pendidikan->kd_jenjang->Visible) { // kd_jenjang ?>
	<div id="r_kd_jenjang" class="form-group">
		<label id="elh_pendidikan_kd_jenjang" for="x_kd_jenjang" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->kd_jenjang->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->kd_jenjang->CellAttributes() ?>>
<span id="el_pendidikan_kd_jenjang">
<span<?php echo $pendidikan->kd_jenjang->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pendidikan->kd_jenjang->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pendidikan" data-field="x_kd_jenjang" name="x_kd_jenjang" id="x_kd_jenjang" value="<?php echo ew_HtmlEncode($pendidikan->kd_jenjang->CurrentValue) ?>">
...
<?php if ($pendidikan->kd_jurusan->Visible) { // kd_jurusan ?>
	<div id="r_kd_jurusan" class="form-group">
		<label id="elh_pendidikan_kd_jurusan" for="x_kd_jurusan" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->kd_jurusan->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->kd_jurusan->CellAttributes() ?>>
...
<?php if ($pendidikan->kd_lmbg->Visible) { // kd_lmbg ?>
	<div id="r_kd_lmbg" class="form-group">
		<label id="elh_pendidikan_kd_lmbg" for="x_kd_lmbg" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->kd_lmbg->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->kd_lmbg->CellAttributes() ?>>
...
<?php if ($pendidikan->ipk->Visible) { // ipk ?>
	<div id="r_ipk" class="form-group">
		<label id="elh_pendidikan_ipk" for="x_ipk" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->ipk->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->ipk->CellAttributes() ?>>
...
<?php if ($pendidikan->ket->Visible) { // ket ?>
	<div id="r_ket" class="form-group">
		<label id="elh_pendidikan_ket" for="x_ket" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->ket->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->ket->CellAttributes() ?>>
...
<?php if ($pendidikan->th_mulai->Visible) { // th_mulai ?>
	<div id="r_th_mulai" class="form-group">
		<label id="elh_pendidikan_th_mulai" for="x_th_mulai" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->th_mulai->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->th_mulai->CellAttributes() ?>>
...
<?php if ($pendidikan->th_akhir->Visible) { // th_akhir ?>
	<div id="r_th_akhir" class="form-group">
		<label id="elh_pendidikan_th_akhir" for="x_th_akhir" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->th_akhir->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->th_akhir->CellAttributes() ?>>
...
<?php if ($pendidikan->no_ijazah->Visible) { // no_ijazah ?>
	<div id="r_no_ijazah" class="form-group">
		<label id="elh_pendidikan_no_ijazah" for="x_no_ijazah" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->no_ijazah->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->no_ijazah->CellAttributes() ?>>
...
<?php if ($pendidikan->tanggal_ijazah->Visible) { // tanggal_ijazah ?>
	<div id="r_tanggal_ijazah" class="form-group">
		<label id="elh_pendidikan_tanggal_ijazah" for="x_tanggal_ijazah" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->tanggal_ijazah->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->tanggal_ijazah->CellAttributes() ?>>
...
<?php if ($pendidikan->upload_ijazah->Visible) { // upload_ijazah ?>
	<div id="r_upload_ijazah" class="form-group">
		<label id="elh_pendidikan_upload_ijazah" for="x_upload_ijazah" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->upload_ijazah->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->upload_ijazah->CellAttributes() ?>>
...
<?php if ($pendidikan->lokasi_pendidikan->Visible) { // lokasi_pendidikan ?>
	<div id="r_lokasi_pendidikan" class="form-group">
		<label id="elh_pendidikan_lokasi_pendidikan" for="x_lokasi_pendidikan" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->lokasi_pendidikan->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->lokasi_pendidikan->CellAttributes() ?>>
...
<?php if ($pendidikan->app->Visible) { // app ?>
	<div id="r_app" class="form-group">
		<label id="elh_pendidikan_app" for="x_app" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->app->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->app->CellAttributes() ?>>
...
<?php if ($pendidikan->app_empid->Visible) { // app_empid ?>
	<div id="r_app_empid" class="form-group">
		<label id="elh_pendidikan_app_empid" for="x_app_empid" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->app_empid->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->app_empid->CellAttributes() ?>>
...
<?php if ($pendidikan->app_jbt->Visible) { // app_jbt ?>
	<div id="r_app_jbt" class="form-group">
		<label id="elh_pendidikan_app_jbt" for="x_app_jbt" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->app_jbt->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->app_jbt->CellAttributes() ?>>
...
<?php if ($pendidikan->app_date->Visible) { // app_date ?>
	<div id="r_app_date" class="form-group">
		<label id="elh_pendidikan_app_date" for="x_app_date" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->app_date->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->app_date->CellAttributes() ?>>
...
<?php if ($pendidikan->created_by->Visible) { // created_by ?>
	<div id="r_created_by" class="form-group">
		<label id="elh_pendidikan_created_by" for="x_created_by" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->created_by->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->created_by->CellAttributes() ?>>
...
<?php if ($pendidikan->created_date->Visible) { // created_date ?>
	<div id="r_created_date" class="form-group">
		<label id="elh_pendidikan_created_date" for="x_created_date" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->created_date->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->created_date->CellAttributes() ?>>
...
<?php if ($pendidikan->last_update_by->Visible) { // last_update_by ?>
	<div id="r_last_update_by" class="form-group">
		<label id="elh_pendidikan_last_update_by" for="x_last_update_by" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->last_update_by->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->last_update_by->CellAttributes() ?>>
...
<?php if ($pendidikan->last_update_date->Visible) { // last_update_date ?>
	<div id="r_last_update_date" class="form-group">
		<label id="elh_pendidikan_last_update_date" for="x_last_update_date" class="<?php echo $pendidikan_edit->LeftColumnClass ?>"><?php echo $pendidikan->last_update_date->FldCaption() ?></label>
		<div class="<?php echo $pendidikan_edit->RightColumnClass ?>"><div<?php echo $pendidikan->last_update_date->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $pendidikan_edit->OffsetColumnClass ?>"><!-- buttons offset -->
