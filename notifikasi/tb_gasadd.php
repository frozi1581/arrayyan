...
$tb_gas_add = NULL; // Initialize page object first

class ctb_gas_add extends ctb_gas {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["kd_gas"] != "") {
				...
				$this->setKey("kd_gas", $this->kd_gas->CurrentValue); // Set up key
			} else {
				$this->setKey("kd_gas", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "tb_gasview.php")
	...
	function LoadDefaultValues() {
		...
		$this->parent_kd_gas->CurrentValue = NULL;
		$this->parent_kd_gas->OldValue = $this->parent_kd_gas->CurrentValue;
		$this->old_kd_gas->CurrentValue = NULL;
		$this->old_kd_gas->OldValue = $this->old_kd_gas->CurrentValue;
		$this->old_ket_gas->CurrentValue = NULL;
		$this->old_ket_gas->OldValue = $this->old_ket_gas->CurrentValue;
	...
	function NewRow() {
		...
		$row['parent_kd_gas'] = $this->parent_kd_gas->CurrentValue;
		$row['old_kd_gas'] = $this->old_kd_gas->CurrentValue;
		$row['old_ket_gas'] = $this->old_ket_gas->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// kd_gas
		$this->kd_gas->SetDbValueDef($rsnew, $this->kd_gas->CurrentValue, "", FALSE);
		...
		// parent_kd_gas
		$this->parent_kd_gas->SetDbValueDef($rsnew, $this->parent_kd_gas->CurrentValue, NULL, FALSE);

		// old_kd_gas
		$this->old_kd_gas->SetDbValueDef($rsnew, $this->old_kd_gas->CurrentValue, NULL, FALSE);

		// old_ket_gas
		$this->old_ket_gas->SetDbValueDef($rsnew, $this->old_ket_gas->CurrentValue, NULL, FALSE);
		...
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['kd_gas']) == "") {
...
// Create page object
if (!isset($tb_gas_add)) $tb_gas_add = new ctb_gas_add();

// Page init
$tb_gas_add->Page_Init();

// Page main
$tb_gas_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_gas_add->Page_Render();
?>
...
var CurrentForm = ftb_gasadd = new ew_Form("ftb_gasadd", "add");

// Validate form
ftb_gasadd.Validate = function() {
...
ftb_gasadd.Form_CustomValidate = 
...
ftb_gasadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $tb_gas_add->ShowPageHeader(); ?>
<?php
$tb_gas_add->ShowMessage();
?>
<form name="ftb_gasadd" id="ftb_gasadd" class="<?php echo $tb_gas_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_gas_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_gas_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_gas">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($tb_gas_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($tb_gas->kd_gas->Visible) { // kd_gas ?>
	<div id="r_kd_gas" class="form-group">
		<label id="elh_tb_gas_kd_gas" for="x_kd_gas" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->kd_gas->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->kd_gas->CellAttributes() ?>>
<span id="el_tb_gas_kd_gas">
<input type="text" data-table="tb_gas" data-field="x_kd_gas" name="x_kd_gas" id="x_kd_gas" size="30" maxlength="3" placeholder="<?php echo ew_HtmlEncode($tb_gas->kd_gas->getPlaceHolder()) ?>" value="<?php echo $tb_gas->kd_gas->EditValue ?>"<?php echo $tb_gas->kd_gas->EditAttributes() ?>>
</span>
...
<?php if ($tb_gas->ket->Visible) { // ket ?>
	<div id="r_ket" class="form-group">
		<label id="elh_tb_gas_ket" for="x_ket" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->ket->FldCaption() ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->ket->CellAttributes() ?>>
...
<?php if ($tb_gas->created_by->Visible) { // created_by ?>
	<div id="r_created_by" class="form-group">
		<label id="elh_tb_gas_created_by" for="x_created_by" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->created_by->FldCaption() ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->created_by->CellAttributes() ?>>
...
<?php if ($tb_gas->created_date->Visible) { // created_date ?>
	<div id="r_created_date" class="form-group">
		<label id="elh_tb_gas_created_date" for="x_created_date" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->created_date->FldCaption() ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->created_date->CellAttributes() ?>>
...
<?php if ($tb_gas->last_update_by->Visible) { // last_update_by ?>
	<div id="r_last_update_by" class="form-group">
		<label id="elh_tb_gas_last_update_by" for="x_last_update_by" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->last_update_by->FldCaption() ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->last_update_by->CellAttributes() ?>>
...
<?php if ($tb_gas->last_update_date->Visible) { // last_update_date ?>
	<div id="r_last_update_date" class="form-group">
		<label id="elh_tb_gas_last_update_date" for="x_last_update_date" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->last_update_date->FldCaption() ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->last_update_date->CellAttributes() ?>>
...
<?php if ($tb_gas->parent_kd_gas->Visible) { // parent_kd_gas ?>
	<div id="r_parent_kd_gas" class="form-group">
		<label id="elh_tb_gas_parent_kd_gas" for="x_parent_kd_gas" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->parent_kd_gas->FldCaption() ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->parent_kd_gas->CellAttributes() ?>>
...
<?php if ($tb_gas->old_kd_gas->Visible) { // old_kd_gas ?>
	<div id="r_old_kd_gas" class="form-group">
		<label id="elh_tb_gas_old_kd_gas" for="x_old_kd_gas" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->old_kd_gas->FldCaption() ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->old_kd_gas->CellAttributes() ?>>
...
<?php if ($tb_gas->old_ket_gas->Visible) { // old_ket_gas ?>
	<div id="r_old_ket_gas" class="form-group">
		<label id="elh_tb_gas_old_ket_gas" for="x_old_ket_gas" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->old_ket_gas->FldCaption() ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->old_ket_gas->CellAttributes() ?>>
...
<?php if ($tb_gas->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_tb_gas_status" for="x_status" class="<?php echo $tb_gas_add->LeftColumnClass ?>"><?php echo $tb_gas->status->FldCaption() ?></label>
		<div class="<?php echo $tb_gas_add->RightColumnClass ?>"><div<?php echo $tb_gas->status->CellAttributes() ?>>
...
<?php if (!$tb_gas_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tb_gas_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tb_gas_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
