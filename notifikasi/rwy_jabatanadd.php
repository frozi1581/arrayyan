...
$rwy_jabatan_add = NULL; // Initialize page object first

class crwy_jabatan_add extends crwy_jabatan {
	...
	// Page object name
	var $PageObjName = 'rwy_jabatan_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "rwy_jabatanview.php")
	...
	function LoadDefaultValues() {
		...
		$this->fungsi_bidang->CurrentValue = NULL;
		$this->fungsi_bidang->OldValue = $this->fungsi_bidang->CurrentValue;
		$this->berlaku_sejak->CurrentValue = NULL;
		$this->berlaku_sejak->OldValue = $this->berlaku_sejak->CurrentValue;
		...
		$this->status_jabatan->CurrentValue = NULL;
		$this->status_jabatan->OldValue = $this->status_jabatan->CurrentValue;
		$this->status_rwy_jabatan->CurrentValue = NULL;
		$this->status_rwy_jabatan->OldValue = $this->status_rwy_jabatan->CurrentValue;
	...
	function NewRow() {
		...
		$row['fungsi_bidang'] = $this->fungsi_bidang->CurrentValue;
		$row['berlaku_sejak'] = $this->berlaku_sejak->CurrentValue;
		...
		$row['status_jabatan'] = $this->status_jabatan->CurrentValue;
		$row['status_rwy_jabatan'] = $this->status_rwy_jabatan->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// fungsi_bidang
		$this->fungsi_bidang->SetDbValueDef($rsnew, $this->fungsi_bidang->CurrentValue, NULL, FALSE);

		// berlaku_sejak
		$this->berlaku_sejak->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->berlaku_sejak->CurrentValue, 0), NULL, FALSE);

		// tanggal_berakhir
		$this->tanggal_berakhir->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tanggal_berakhir->CurrentValue, 0), NULL, FALSE);

		// no_sk
		$this->no_sk->SetDbValueDef($rsnew, $this->no_sk->CurrentValue, NULL, FALSE);

		// tanggal_sk
		$this->tanggal_sk->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tanggal_sk->CurrentValue, 0), NULL, FALSE);

		// status_jabatan
		$this->status_jabatan->SetDbValueDef($rsnew, $this->status_jabatan->CurrentValue, NULL, FALSE);

		// status_rwy_jabatan
		$this->status_rwy_jabatan->SetDbValueDef($rsnew, $this->status_rwy_jabatan->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($rwy_jabatan_add)) $rwy_jabatan_add = new crwy_jabatan_add();

// Page init
$rwy_jabatan_add->Page_Init();

// Page main
$rwy_jabatan_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rwy_jabatan_add->Page_Render();
?>
...
var CurrentForm = frwy_jabatanadd = new ew_Form("frwy_jabatanadd", "add");

// Validate form
frwy_jabatanadd.Validate = function() {
...
frwy_jabatanadd.Form_CustomValidate = 
...
frwy_jabatanadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $rwy_jabatan_add->ShowPageHeader(); ?>
<?php
$rwy_jabatan_add->ShowMessage();
?>
<form name="frwy_jabatanadd" id="frwy_jabatanadd" class="<?php echo $rwy_jabatan_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rwy_jabatan_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rwy_jabatan_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rwy_jabatan">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($rwy_jabatan_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($rwy_jabatan->nip->Visible) { // nip ?>
	<div id="r_nip" class="form-group">
		<label id="elh_rwy_jabatan_nip" for="x_nip" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->nip->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->nip->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->kode_unit_organisasi->Visible) { // kode_unit_organisasi ?>
	<div id="r_kode_unit_organisasi" class="form-group">
		<label id="elh_rwy_jabatan_kode_unit_organisasi" for="x_kode_unit_organisasi" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->kode_unit_organisasi->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->kode_unit_organisasi->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->kode_unit_kerja->Visible) { // kode_unit_kerja ?>
	<div id="r_kode_unit_kerja" class="form-group">
		<label id="elh_rwy_jabatan_kode_unit_kerja" for="x_kode_unit_kerja" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->kode_unit_kerja->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->kode_unit_kerja->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->jabatan->Visible) { // jabatan ?>
	<div id="r_jabatan" class="form-group">
		<label id="elh_rwy_jabatan_jabatan" for="x_jabatan" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->jabatan->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->jabatan->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->fungsi_bidang->Visible) { // fungsi_bidang ?>
	<div id="r_fungsi_bidang" class="form-group">
		<label id="elh_rwy_jabatan_fungsi_bidang" for="x_fungsi_bidang" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->fungsi_bidang->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->fungsi_bidang->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->berlaku_sejak->Visible) { // berlaku_sejak ?>
	<div id="r_berlaku_sejak" class="form-group">
		<label id="elh_rwy_jabatan_berlaku_sejak" for="x_berlaku_sejak" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->berlaku_sejak->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->berlaku_sejak->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->tanggal_berakhir->Visible) { // tanggal_berakhir ?>
	<div id="r_tanggal_berakhir" class="form-group">
		<label id="elh_rwy_jabatan_tanggal_berakhir" for="x_tanggal_berakhir" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->tanggal_berakhir->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->tanggal_berakhir->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->no_sk->Visible) { // no_sk ?>
	<div id="r_no_sk" class="form-group">
		<label id="elh_rwy_jabatan_no_sk" for="x_no_sk" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->no_sk->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->no_sk->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->tanggal_sk->Visible) { // tanggal_sk ?>
	<div id="r_tanggal_sk" class="form-group">
		<label id="elh_rwy_jabatan_tanggal_sk" for="x_tanggal_sk" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->tanggal_sk->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->tanggal_sk->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->status_jabatan->Visible) { // status_jabatan ?>
	<div id="r_status_jabatan" class="form-group">
		<label id="elh_rwy_jabatan_status_jabatan" for="x_status_jabatan" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->status_jabatan->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->status_jabatan->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->status_rwy_jabatan->Visible) { // status_rwy_jabatan ?>
	<div id="r_status_rwy_jabatan" class="form-group">
		<label id="elh_rwy_jabatan_status_rwy_jabatan" for="x_status_rwy_jabatan" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->status_rwy_jabatan->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->status_rwy_jabatan->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->stat_validasi->Visible) { // stat_validasi ?>
	<div id="r_stat_validasi" class="form-group">
		<label id="elh_rwy_jabatan_stat_validasi" for="x_stat_validasi" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->stat_validasi->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->stat_validasi->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->change_by->Visible) { // change_by ?>
	<div id="r_change_by" class="form-group">
		<label id="elh_rwy_jabatan_change_by" for="x_change_by" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->change_by->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->change_by->CellAttributes() ?>>
...
<?php if ($rwy_jabatan->change_date->Visible) { // change_date ?>
	<div id="r_change_date" class="form-group">
		<label id="elh_rwy_jabatan_change_date" for="x_change_date" class="<?php echo $rwy_jabatan_add->LeftColumnClass ?>"><?php echo $rwy_jabatan->change_date->FldCaption() ?></label>
		<div class="<?php echo $rwy_jabatan_add->RightColumnClass ?>"><div<?php echo $rwy_jabatan->change_date->CellAttributes() ?>>
...
<?php if (!$rwy_jabatan_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $rwy_jabatan_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rwy_jabatan_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
frwy_jabatanadd.Init();
</script>
<?php
$rwy_jabatan_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rwy_jabatan_add->Page_Terminate();
?>
