...
$rwy_bidang_keahlian = NULL;

//
// Table class for rwy_bidang_keahlian
//
class crwy_bidang_keahlian extends cTable {
	var $id;
	var $nip;
	var $nama_bidang;
	var $keterangan;
	...
	function __construct() {
		...
		$this->TableVar = 'rwy_bidang_keahlian';
		$this->TableName = 'rwy_bidang_keahlian';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`rwy_bidang_keahlian`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('rwy_bidang_keahlian', 'rwy_bidang_keahlian', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// nip
		$this->nip = new cField('rwy_bidang_keahlian', 'rwy_bidang_keahlian', 'x_nip', 'nip', '`nip`', '`nip`', 200, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip->Sortable = TRUE; // Allow sort
		$this->fields['nip'] = &$this->nip;

		// nama_bidang
		$this->nama_bidang = new cField('rwy_bidang_keahlian', 'rwy_bidang_keahlian', 'x_nama_bidang', 'nama_bidang', '`nama_bidang`', '`nama_bidang`', 200, -1, FALSE, '`nama_bidang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_bidang->Sortable = TRUE; // Allow sort
		$this->fields['nama_bidang'] = &$this->nama_bidang;

		// keterangan
		$this->keterangan = new cField('rwy_bidang_keahlian', 'rwy_bidang_keahlian', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 201, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// stat_validasi
		$this->stat_validasi = new cField('rwy_bidang_keahlian', 'rwy_bidang_keahlian', 'x_stat_validasi', 'stat_validasi', '`stat_validasi`', '`stat_validasi`', 3, -1, FALSE, '`stat_validasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// change_date
		$this->change_date = new cField('rwy_bidang_keahlian', 'rwy_bidang_keahlian', 'x_change_date', 'change_date', '`change_date`', ew_CastDateFieldForLike('`change_date`', 0, "DB"), 135, 0, FALSE, '`change_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// change_by
		$this->change_by = new cField('rwy_bidang_keahlian', 'rwy_bidang_keahlian', 'x_change_by', 'change_by', '`change_by`', '`change_by`', 200, -1, FALSE, '`change_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`rwy_bidang_keahlian`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "rwy_bidang_keahlianlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "rwy_bidang_keahlianedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "rwy_bidang_keahlianadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("rwy_bidang_keahlianview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("rwy_bidang_keahlianview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "rwy_bidang_keahlianadd.php?" . $this->UrlParm($parm);
		else
			$url = "rwy_bidang_keahlianadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("rwy_bidang_keahlianedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("rwy_bidang_keahlianadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("rwy_bidang_keahliandelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->nama_bidang->setDbValue($rs->fields('nama_bidang'));
	...
	function RenderEditRow() {
		...
		$this->nama_bidang->EditValue = $this->nama_bidang->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->nama_bidang->Exportable) $Doc->ExportCaption($this->nama_bidang);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->nama_bidang->Exportable) $Doc->ExportField($this->nama_bidang);
