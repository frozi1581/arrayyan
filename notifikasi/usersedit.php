...
class cusers_edit extends cusers {
	...
	function EditRow() {
		...
		if ($this->nip->CurrentValue <> "") { // Check field with unique index
			$sFilterChk = "(`nip` = '" . ew_AdjustSql($this->nip->CurrentValue, $this->DBID) . "')";
		...
		if ($rs->EOF) {
			...
			// user_group
			$this->user_group->SetDbValueDef($rsnew, $this->user_group->CurrentValue, 0, $this->user_group->ReadOnly);
			...
			// nomor_anggota
			$this->nomor_anggota->SetDbValueDef($rsnew, $this->nomor_anggota->CurrentValue, NULL, $this->nomor_anggota->ReadOnly);

			// nip
			$this->nip->SetDbValueDef($rsnew, $this->nip->CurrentValue, NULL, $this->nip->ReadOnly);

			// nip_lama
			$this->nip_lama->SetDbValueDef($rsnew, $this->nip_lama->CurrentValue, NULL, $this->nip_lama->ReadOnly);

			// gelar_depan
			$this->gelar_depan->SetDbValueDef($rsnew, $this->gelar_depan->CurrentValue, NULL, $this->gelar_depan->ReadOnly);

			// gelar_belakang
			$this->gelar_belakang->SetDbValueDef($rsnew, $this->gelar_belakang->CurrentValue, NULL, $this->gelar_belakang->ReadOnly);
			...
			// warga_negara
			$this->warga_negara->SetDbValueDef($rsnew, $this->warga_negara->CurrentValue, NULL, $this->warga_negara->ReadOnly);
			...
			// status_perkawinan
			$this->status_perkawinan->SetDbValueDef($rsnew, $this->status_perkawinan->CurrentValue, NULL, $this->status_perkawinan->ReadOnly);
			...
			// change_by
			$this->change_by->SetDbValueDef($rsnew, $this->change_by->CurrentValue, "", $this->change_by->ReadOnly);
...
<?php if ($users->nama_pegawai->Visible) { // nama_pegawai ?>
	<div id="r_nama_pegawai" class="form-group">
		<label id="elh_users_nama_pegawai" for="x_nama_pegawai" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->nama_pegawai->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->nama_pegawai->CellAttributes() ?>>
...
<?php if ($users->kode_unit_organisasi->Visible) { // kode_unit_organisasi ?>
	<div id="r_kode_unit_organisasi" class="form-group">
		<label id="elh_users_kode_unit_organisasi" for="x_kode_unit_organisasi" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->kode_unit_organisasi->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->kode_unit_organisasi->CellAttributes() ?>>
...
<?php if ($users->kode_unit_kerja->Visible) { // kode_unit_kerja ?>
	<div id="r_kode_unit_kerja" class="form-group">
		<label id="elh_users_kode_unit_kerja" for="x_kode_unit_kerja" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->kode_unit_kerja->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->kode_unit_kerja->CellAttributes() ?>>
...
<?php if ($users->jabatan->Visible) { // jabatan ?>
	<div id="r_jabatan" class="form-group">
		<label id="elh_users_jabatan" for="x_jabatan" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->jabatan->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->jabatan->CellAttributes() ?>>
...
<?php if ($users->user_group->Visible) { // user_group ?>
	<div id="r_user_group" class="form-group">
		<label id="elh_users_user_group" for="x_user_group" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->user_group->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->user_group->CellAttributes() ?>>
...
<?php if ($users->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_users_status" for="x_status" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($users->photo->Visible) { // photo ?>
	<div id="r_photo" class="form-group">
		<label id="elh_users_photo" for="x_photo" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->photo->FldCaption() ?></label>
...
<?php if ($users->nomor_anggota->Visible) { // nomor_anggota ?>
	<div id="r_nomor_anggota" class="form-group">
		<label id="elh_users_nomor_anggota" for="x_nomor_anggota" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->nomor_anggota->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->nomor_anggota->CellAttributes() ?>>
...
<?php if ($users->nip->Visible) { // nip ?>
	<div id="r_nip" class="form-group">
		<label id="elh_users_nip" for="x_nip" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->nip->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->nip->CellAttributes() ?>>
...
<?php if ($users->nip_lama->Visible) { // nip_lama ?>
	<div id="r_nip_lama" class="form-group">
		<label id="elh_users_nip_lama" for="x_nip_lama" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->nip_lama->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->nip_lama->CellAttributes() ?>>
...
<?php if ($users->gelar_depan->Visible) { // gelar_depan ?>
	<div id="r_gelar_depan" class="form-group">
		<label id="elh_users_gelar_depan" for="x_gelar_depan" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->gelar_depan->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->gelar_depan->CellAttributes() ?>>
...
<?php if ($users->gelar_belakang->Visible) { // gelar_belakang ?>
	<div id="r_gelar_belakang" class="form-group">
		<label id="elh_users_gelar_belakang" for="x_gelar_belakang" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->gelar_belakang->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->gelar_belakang->CellAttributes() ?>>
...
<?php if ($users->pendidikan_terakhir->Visible) { // pendidikan_terakhir ?>
	<div id="r_pendidikan_terakhir" class="form-group">
		<label id="elh_users_pendidikan_terakhir" for="x_pendidikan_terakhir" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->pendidikan_terakhir->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->pendidikan_terakhir->CellAttributes() ?>>
...
<?php if ($users->nama_lembaga->Visible) { // nama_lembaga ?>
	<div id="r_nama_lembaga" class="form-group">
		<label id="elh_users_nama_lembaga" for="x_nama_lembaga" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->nama_lembaga->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->nama_lembaga->CellAttributes() ?>>
...
<?php if ($users->warga_negara->Visible) { // warga_negara ?>
	<div id="r_warga_negara" class="form-group">
		<label id="elh_users_warga_negara" for="x_warga_negara" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->warga_negara->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->warga_negara->CellAttributes() ?>>
...
<?php if ($users->tempat_lahir->Visible) { // tempat_lahir ?>
	<div id="r_tempat_lahir" class="form-group">
		<label id="elh_users_tempat_lahir" for="x_tempat_lahir" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->tempat_lahir->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->tempat_lahir->CellAttributes() ?>>
...
<?php if ($users->tanggal_lahir->Visible) { // tanggal_lahir ?>
	<div id="r_tanggal_lahir" class="form-group">
		<label id="elh_users_tanggal_lahir" for="x_tanggal_lahir" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->tanggal_lahir->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->tanggal_lahir->CellAttributes() ?>>
...
<?php if ($users->jenis_kelamin->Visible) { // jenis_kelamin ?>
	<div id="r_jenis_kelamin" class="form-group">
		<label id="elh_users_jenis_kelamin" for="x_jenis_kelamin" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->jenis_kelamin->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->jenis_kelamin->CellAttributes() ?>>
...
<?php if ($users->status_perkawinan->Visible) { // status_perkawinan ?>
	<div id="r_status_perkawinan" class="form-group">
		<label id="elh_users_status_perkawinan" for="x_status_perkawinan" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->status_perkawinan->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->status_perkawinan->CellAttributes() ?>>
...
<?php if ($users->agama->Visible) { // agama ?>
	<div id="r_agama" class="form-group">
		<label id="elh_users_agama" for="x_agama" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->agama->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->agama->CellAttributes() ?>>
...
<?php if ($users->nama_bank->Visible) { // nama_bank ?>
	<div id="r_nama_bank" class="form-group">
		<label id="elh_users_nama_bank" for="x_nama_bank" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->nama_bank->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->nama_bank->CellAttributes() ?>>
...
<?php if ($users->no_rekening->Visible) { // no_rekening ?>
	<div id="r_no_rekening" class="form-group">
		<label id="elh_users_no_rekening" for="x_no_rekening" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->no_rekening->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->no_rekening->CellAttributes() ?>>
...
<?php if ($users->change_date->Visible) { // change_date ?>
	<div id="r_change_date" class="form-group">
		<label id="elh_users_change_date" for="x_change_date" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->change_date->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->change_date->CellAttributes() ?>>
...
<?php if ($users->change_by->Visible) { // change_by ?>
	<div id="r_change_by" class="form-group">
		<label id="elh_users_change_by" for="x_change_by" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->change_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->change_by->CellAttributes() ?>>
