...
//
// Table class for rwy_keluarga
//
class crwy_keluarga extends cTable {
	var $id;
	var $nip;
	var $hubungan_keluarga;
	var $nama_lengkap;
	var $tanggal_lahir;
	var $tempat_lahir;
	...
	function __construct() {
		...
		$this->TableVar = 'rwy_keluarga';
		$this->TableName = 'rwy_keluarga';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`rwy_keluarga`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('rwy_keluarga', 'rwy_keluarga', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// nip
		$this->nip = new cField('rwy_keluarga', 'rwy_keluarga', 'x_nip', 'nip', '`nip`', '`nip`', 200, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip->Sortable = TRUE; // Allow sort
		$this->fields['nip'] = &$this->nip;

		// hubungan_keluarga
		$this->hubungan_keluarga = new cField('rwy_keluarga', 'rwy_keluarga', 'x_hubungan_keluarga', 'hubungan_keluarga', '`hubungan_keluarga`', '`hubungan_keluarga`', 200, -1, FALSE, '`hubungan_keluarga`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hubungan_keluarga->Sortable = TRUE; // Allow sort
		$this->fields['hubungan_keluarga'] = &$this->hubungan_keluarga;

		// nama_lengkap
		$this->nama_lengkap = new cField('rwy_keluarga', 'rwy_keluarga', 'x_nama_lengkap', 'nama_lengkap', '`nama_lengkap`', '`nama_lengkap`', 201, -1, FALSE, '`nama_lengkap`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->nama_lengkap->Sortable = TRUE; // Allow sort
		$this->fields['nama_lengkap'] = &$this->nama_lengkap;

		// tanggal_lahir
		$this->tanggal_lahir = new cField('rwy_keluarga', 'rwy_keluarga', 'x_tanggal_lahir', 'tanggal_lahir', '`tanggal_lahir`', ew_CastDateFieldForLike('`tanggal_lahir`', 0, "DB"), 133, 0, FALSE, '`tanggal_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tempat_lahir
		$this->tempat_lahir = new cField('rwy_keluarga', 'rwy_keluarga', 'x_tempat_lahir', 'tempat_lahir', '`tempat_lahir`', '`tempat_lahir`', 200, -1, FALSE, '`tempat_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tempat_lahir->Sortable = TRUE; // Allow sort
		$this->fields['tempat_lahir'] = &$this->tempat_lahir;

		// pendidikan_terakhir
		$this->pendidikan_terakhir = new cField('rwy_keluarga', 'rwy_keluarga', 'x_pendidikan_terakhir', 'pendidikan_terakhir', '`pendidikan_terakhir`', '`pendidikan_terakhir`', 200, -1, FALSE, '`pendidikan_terakhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pendidikan_terakhir->Sortable = TRUE; // Allow sort
		$this->fields['pendidikan_terakhir'] = &$this->pendidikan_terakhir;

		// jurusan
		$this->jurusan = new cField('rwy_keluarga', 'rwy_keluarga', 'x_jurusan', 'jurusan', '`jurusan`', '`jurusan`', 200, -1, FALSE, '`jurusan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jurusan->Sortable = TRUE; // Allow sort
		$this->fields['jurusan'] = &$this->jurusan;

		// jenis_kelamin
		$this->jenis_kelamin = new cField('rwy_keluarga', 'rwy_keluarga', 'x_jenis_kelamin', 'jenis_kelamin', '`jenis_kelamin`', '`jenis_kelamin`', 200, -1, FALSE, '`jenis_kelamin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jenis_kelamin->Sortable = TRUE; // Allow sort
		$this->fields['jenis_kelamin'] = &$this->jenis_kelamin;

		// stat_validasi
		$this->stat_validasi = new cField('rwy_keluarga', 'rwy_keluarga', 'x_stat_validasi', 'stat_validasi', '`stat_validasi`', '`stat_validasi`', 3, -1, FALSE, '`stat_validasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// change_date
		$this->change_date = new cField('rwy_keluarga', 'rwy_keluarga', 'x_change_date', 'change_date', '`change_date`', ew_CastDateFieldForLike('`change_date`', 0, "DB"), 135, 0, FALSE, '`change_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// change_by
		$this->change_by = new cField('rwy_keluarga', 'rwy_keluarga', 'x_change_by', 'change_by', '`change_by`', '`change_by`', 200, -1, FALSE, '`change_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`rwy_keluarga`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "rwy_keluargaedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "rwy_keluargaadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("rwy_keluargaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("rwy_keluargaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "rwy_keluargaadd.php?" . $this->UrlParm($parm);
		else
			$url = "rwy_keluargaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("rwy_keluargaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("rwy_keluargaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("rwy_keluargadelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->hubungan_keluarga->setDbValue($rs->fields('hubungan_keluarga'));
	...
	function RenderEditRow() {
		...
		$this->hubungan_keluarga->EditValue = $this->hubungan_keluarga->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->hubungan_keluarga->Exportable) $Doc->ExportCaption($this->hubungan_keluarga);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->hubungan_keluarga->Exportable) $Doc->ExportField($this->hubungan_keluarga);
