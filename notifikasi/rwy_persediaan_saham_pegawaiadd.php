...
$rwy_persediaan_saham_pegawai_add = NULL; // Initialize page object first

class crwy_persediaan_saham_pegawai_add extends crwy_persediaan_saham_pegawai {
	...
	// Page object name
	var $PageObjName = 'rwy_persediaan_saham_pegawai_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "rwy_persediaan_saham_pegawaiview.php")
	...
	function LoadDefaultValues() {
		...
		$this->periode_bulan->CurrentValue = 0;
		$this->periode_tahun->CurrentValue = 0;
		$this->industri_kontruksi_abim_ups_anak->CurrentValue = 0;
		$this->realty_ups_anak->CurrentValue = 0;
		$this->pst_ups_anak->CurrentValue = 0;
		$this->wton_anak_ups_anak->CurrentValue = 0;
		$this->industri_kontruksi_abim_ups_dianak->CurrentValue = 0;
		$this->realty_ups_dianak->CurrentValue = 0;
		$this->esa_dianak->CurrentValue = 0;
		$this->esop_dianak->CurrentValue = 0;
	...
	function NewRow() {
		...
		$row['periode_bulan'] = $this->periode_bulan->CurrentValue;
		$row['periode_tahun'] = $this->periode_tahun->CurrentValue;
		$row['industri_kontruksi_abim_ups_anak'] = $this->industri_kontruksi_abim_ups_anak->CurrentValue;
		$row['realty_ups_anak'] = $this->realty_ups_anak->CurrentValue;
		$row['pst_ups_anak'] = $this->pst_ups_anak->CurrentValue;
		$row['wton_anak_ups_anak'] = $this->wton_anak_ups_anak->CurrentValue;
		$row['industri_kontruksi_abim_ups_dianak'] = $this->industri_kontruksi_abim_ups_dianak->CurrentValue;
		$row['realty_ups_dianak'] = $this->realty_ups_dianak->CurrentValue;
		$row['esa_dianak'] = $this->esa_dianak->CurrentValue;
		$row['esop_dianak'] = $this->esop_dianak->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// periode_bulan
		$this->periode_bulan->SetDbValueDef($rsnew, $this->periode_bulan->CurrentValue, NULL, strval($this->periode_bulan->CurrentValue) == "");

		// periode_tahun
		$this->periode_tahun->SetDbValueDef($rsnew, $this->periode_tahun->CurrentValue, NULL, strval($this->periode_tahun->CurrentValue) == "");

		// industri_kontruksi_abim_ups_anak
		$this->industri_kontruksi_abim_ups_anak->SetDbValueDef($rsnew, $this->industri_kontruksi_abim_ups_anak->CurrentValue, NULL, strval($this->industri_kontruksi_abim_ups_anak->CurrentValue) == "");

		// realty_ups_anak
		$this->realty_ups_anak->SetDbValueDef($rsnew, $this->realty_ups_anak->CurrentValue, NULL, strval($this->realty_ups_anak->CurrentValue) == "");

		// pst_ups_anak
		$this->pst_ups_anak->SetDbValueDef($rsnew, $this->pst_ups_anak->CurrentValue, NULL, strval($this->pst_ups_anak->CurrentValue) == "");

		// wton_anak_ups_anak
		$this->wton_anak_ups_anak->SetDbValueDef($rsnew, $this->wton_anak_ups_anak->CurrentValue, NULL, strval($this->wton_anak_ups_anak->CurrentValue) == "");

		// industri_kontruksi_abim_ups_dianak
		$this->industri_kontruksi_abim_ups_dianak->SetDbValueDef($rsnew, $this->industri_kontruksi_abim_ups_dianak->CurrentValue, NULL, strval($this->industri_kontruksi_abim_ups_dianak->CurrentValue) == "");

		// realty_ups_dianak
		$this->realty_ups_dianak->SetDbValueDef($rsnew, $this->realty_ups_dianak->CurrentValue, NULL, strval($this->realty_ups_dianak->CurrentValue) == "");

		// esa_dianak
		$this->esa_dianak->SetDbValueDef($rsnew, $this->esa_dianak->CurrentValue, NULL, strval($this->esa_dianak->CurrentValue) == "");

		// esop_dianak
		$this->esop_dianak->SetDbValueDef($rsnew, $this->esop_dianak->CurrentValue, NULL, strval($this->esop_dianak->CurrentValue) == "");
...
// Create page object
if (!isset($rwy_persediaan_saham_pegawai_add)) $rwy_persediaan_saham_pegawai_add = new crwy_persediaan_saham_pegawai_add();

// Page init
$rwy_persediaan_saham_pegawai_add->Page_Init();

// Page main
$rwy_persediaan_saham_pegawai_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rwy_persediaan_saham_pegawai_add->Page_Render();
?>
...
var CurrentForm = frwy_persediaan_saham_pegawaiadd = new ew_Form("frwy_persediaan_saham_pegawaiadd", "add");

// Validate form
frwy_persediaan_saham_pegawaiadd.Validate = function() {
...
frwy_persediaan_saham_pegawaiadd.Form_CustomValidate = 
...
frwy_persediaan_saham_pegawaiadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $rwy_persediaan_saham_pegawai_add->ShowPageHeader(); ?>
<?php
$rwy_persediaan_saham_pegawai_add->ShowMessage();
?>
<form name="frwy_persediaan_saham_pegawaiadd" id="frwy_persediaan_saham_pegawaiadd" class="<?php echo $rwy_persediaan_saham_pegawai_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rwy_persediaan_saham_pegawai_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rwy_persediaan_saham_pegawai_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rwy_persediaan_saham_pegawai">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($rwy_persediaan_saham_pegawai_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($rwy_persediaan_saham_pegawai->nip->Visible) { // nip ?>
	<div id="r_nip" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_nip" for="x_nip" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->nip->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->nip->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->kode_unit_organisasi->Visible) { // kode_unit_organisasi ?>
	<div id="r_kode_unit_organisasi" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_kode_unit_organisasi" for="x_kode_unit_organisasi" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->kode_unit_organisasi->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->kode_unit_organisasi->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->kode_unit_kerja->Visible) { // kode_unit_kerja ?>
	<div id="r_kode_unit_kerja" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_kode_unit_kerja" for="x_kode_unit_kerja" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->kode_unit_kerja->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->kode_unit_kerja->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->periode_bulan->Visible) { // periode_bulan ?>
	<div id="r_periode_bulan" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_periode_bulan" for="x_periode_bulan" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->periode_bulan->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->periode_bulan->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->periode_tahun->Visible) { // periode_tahun ?>
	<div id="r_periode_tahun" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_periode_tahun" for="x_periode_tahun" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->periode_tahun->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->periode_tahun->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->industri_kontruksi_abim_ups_anak->Visible) { // industri_kontruksi_abim_ups_anak ?>
	<div id="r_industri_kontruksi_abim_ups_anak" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_industri_kontruksi_abim_ups_anak" for="x_industri_kontruksi_abim_ups_anak" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->industri_kontruksi_abim_ups_anak->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->industri_kontruksi_abim_ups_anak->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->realty_ups_anak->Visible) { // realty_ups_anak ?>
	<div id="r_realty_ups_anak" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_realty_ups_anak" for="x_realty_ups_anak" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->realty_ups_anak->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->realty_ups_anak->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->pst_ups_anak->Visible) { // pst_ups_anak ?>
	<div id="r_pst_ups_anak" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_pst_ups_anak" for="x_pst_ups_anak" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->pst_ups_anak->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->pst_ups_anak->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->wton_anak_ups_anak->Visible) { // wton_anak_ups_anak ?>
	<div id="r_wton_anak_ups_anak" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_wton_anak_ups_anak" for="x_wton_anak_ups_anak" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->wton_anak_ups_anak->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->wton_anak_ups_anak->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->industri_kontruksi_abim_ups_dianak->Visible) { // industri_kontruksi_abim_ups_dianak ?>
	<div id="r_industri_kontruksi_abim_ups_dianak" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_industri_kontruksi_abim_ups_dianak" for="x_industri_kontruksi_abim_ups_dianak" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->industri_kontruksi_abim_ups_dianak->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->industri_kontruksi_abim_ups_dianak->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->realty_ups_dianak->Visible) { // realty_ups_dianak ?>
	<div id="r_realty_ups_dianak" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_realty_ups_dianak" for="x_realty_ups_dianak" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->realty_ups_dianak->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->realty_ups_dianak->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->esa_dianak->Visible) { // esa_dianak ?>
	<div id="r_esa_dianak" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_esa_dianak" for="x_esa_dianak" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->esa_dianak->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->esa_dianak->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->esop_dianak->Visible) { // esop_dianak ?>
	<div id="r_esop_dianak" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_esop_dianak" for="x_esop_dianak" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->esop_dianak->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->esop_dianak->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->change_by->Visible) { // change_by ?>
	<div id="r_change_by" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_change_by" for="x_change_by" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->change_by->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->change_by->CellAttributes() ?>>
...
<?php if ($rwy_persediaan_saham_pegawai->change_date->Visible) { // change_date ?>
	<div id="r_change_date" class="form-group">
		<label id="elh_rwy_persediaan_saham_pegawai_change_date" for="x_change_date" class="<?php echo $rwy_persediaan_saham_pegawai_add->LeftColumnClass ?>"><?php echo $rwy_persediaan_saham_pegawai->change_date->FldCaption() ?></label>
		<div class="<?php echo $rwy_persediaan_saham_pegawai_add->RightColumnClass ?>"><div<?php echo $rwy_persediaan_saham_pegawai->change_date->CellAttributes() ?>>
...
<?php if (!$rwy_persediaan_saham_pegawai_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $rwy_persediaan_saham_pegawai_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rwy_persediaan_saham_pegawai_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
frwy_persediaan_saham_pegawaiadd.Init();
</script>
<?php
$rwy_persediaan_saham_pegawai_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rwy_persediaan_saham_pegawai_add->Page_Terminate();
?>
