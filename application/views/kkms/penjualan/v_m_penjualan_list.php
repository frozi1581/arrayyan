                ...
                <div class="form-group">
                    <div class="col-sm-2">
                        <div class="input-group">
                            <input id="tgldokId" type="text" value="<?php echo isset($TglDok)?$TglDok:Date('d/m/Y'); if ($this->session->flashdata('message')) { $data=$this->session->flashdata('message'); if (isset($data['TglDok'])) { echo $data['TglDok']; } }?>" class="form-control tgl-dok" name="txtTglDok" />
                            &nbsp;<small>(format : dd/mm/yyyy, ex : 20/08/2020)</small>
                        </div>
                    </div>
                    <div class="col-sm-1" id="msgNIP">
                    </div>
