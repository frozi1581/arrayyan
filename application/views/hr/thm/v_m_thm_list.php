...
<script type="text/javascript">
	$(document).ready(function () {
		...
		rebindGrid('<?php echo Date("Y"); ?>');
	});
	
	var rebindGrid = function(ithn){	
		var source1 =
		{
			 datatype: "json",
			 datafields: [
			...
			url: '<?php echo base_url().'hr/thm/M_Thm/getGridData/?ithn='; ?>'+ithn,
			root: 'Rows',
		...
		{	width: '100%',
			...
			columns: [
				...
				<ul class="nav nav-tabs">
				  <?php 
						for($ithn=Date("Y"); $ithn>=(Date("Y")-5); $ithn--)
						{
							echo "<li class=\"\"><a data-toggle=\"tab\" href=\"#content1\">$ithn</a></li>";
						}
