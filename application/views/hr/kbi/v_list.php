            ...
            {	width: '99%',
               ...
               // selectionmode: 'checkbox',
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    strNew = '<button id="addrowbutton" name="addrowbutton" style="margin-right:0px;height:20px;border:0px;background:transparent;" title="Add New"><div style="margin: 4px; width: 16px; height: 16px;" class="jqx-icon-plus jqx-icon-plus-darkblue"></div></button>';
                    strEdit = '<button id="editrowbutton" name="editrowbutton" style="margin-right:0px;height:20px;border:0px;background:transparent;" title="Edit"><div style="margin: 4px; width: 16px; height: 16px;" class="jqx-icon-edit jqx-icon-edit-darkblue"></div></i></button>';
