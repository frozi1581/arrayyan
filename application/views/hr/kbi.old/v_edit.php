...
<script type="text/javascript">
        ...
        /*    strDelAll = '<button id="clearrowbutton" name="clearrowbutton" style="margin-right:0px;height:20px;border:0px;background:transparent;" title="Delete All Item"><i class="fa fa-trash-o fa-lg" style="font-size:20px;color:white;"></i></button>';
		  */ // container.append(strEdit);
                   container.append(strNew);container.append(strUpload);
                   container.append(strEdit);container.append(strUsers);container.append(strDel) ; container.append(strApp); container.append(strVSoal);
                                    ...
                                    success: function (data) {
                                       ...
                                       var source =
                                        ...
                                        $("#jqxgrid_soal").jqxGrid({
                                          ...
                                          { text: 'Kriteria Penilaian', datafield: 'jns_kriteria' }
    ...
    <div class="modal-dialog " style="width:1100px">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span></button>
          <h4 class="modal-title">SOAL KBI</h4>
        </div>
        <form role="form" class="form-horizontal" action="#" >
        <div class="modal-body">
            <div class="form-group">
