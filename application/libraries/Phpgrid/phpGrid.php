...
if(PHPGRID_DB_TYPE != 'pdo_odbc_db2'){
	...
	require_once(dirname(__FILE__) .'/server/classes/cls_dbpdo.php');  
}
...
require_once(dirname(__FILE__) .'/server/classes/cls_session.php');  
...
require_once(dirname(__FILE__) .'/server/PHPExcel.php');
require_once(dirname(__FILE__) .'/server/PHPSqlParser/PHPSQLParser.php');
