...
<?php
$dg = new C_DataGrid("select productCode, productName, productLine, productUrl, buyPrice, quantityInStock, MSRP, Image from products", "productCode", "productcode");
