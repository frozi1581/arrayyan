...
<?php
$dg = new C_DataGrid("select Image, productName, productCode, productUrl, productLine, productScale, quantityInStock, MSRP, supplierZip from products", "productCode", "productcode");
