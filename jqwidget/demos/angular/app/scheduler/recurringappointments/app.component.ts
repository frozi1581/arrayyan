...
export class AppComponent implements AfterViewInit {
    ...
    generateAppointments() {
        ...
        let appointment1 = {
            ...
            calendar: 'Room 2',
            from: new Date(2018, 10, 22, 8, 0, 0),
            to: new Date(2018, 10, 22, 13, 0, 0)
        }
        let appointment2 = {
            id: 'id5',
            description: '',
            ...
            calendar: 'Room 1',
            from: new Date(2018, 10, 25, 13, 0, 0),
            to: new Date(2018, 10, 25, 15, 0, 0)
        }
        let appointment3 = {
            id: 'id6',
            description: '',
            ...
            calendar: 'Room 2',
            from: new Date(2018, 10, 26, 14, 0, 0),
            to: new Date(2018, 10, 26, 16, 0, 0)
        }
        let appointment4 = {
            id: 'id7',
            description: '',
            ...
            recurrenceException: '2018-11-24 09:00:00,2018-11-26 12:00:00',
            from: new Date(2018, 10, 23, 10, 0, 0),
            to: new Date(2018, 10, 23, 11, 0, 0)
        }
